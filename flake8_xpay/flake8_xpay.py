                    ...
                    for name in node.names:
                        if name.name not in self.allowed_typing_imports:
                            ...
                            if (
                                ...
                                msg = (
                                    "SPY101 Importing %s from 'typing' is prohibited. Do you need to add to the allowlist in flake8_xpay.py?"
                                    % (name.name)
                                )
                            yield (
                                name.lineno,
                    ...
                    for name in node.names:
                        if (
                            ...
                            if name.name in self.allowed_typing_imports:
                                ...
                                msg = (
                                    "SPY103 Importing '%s' from 'typing_extensions' is prohibited. Do you need to add to the allowlist in flake8_xpay.py?"
                                    % (name.name)
                                )
                            yield (
                                name.lineno,
