...
class TestUpdateableAPIResource(object):
    class MyUpdateable(xpay.api_resources.abstract.UpdateableAPIResource):
    ...
    def test_retrieve_and_update_with_xpay_version(self, request_mock, obj):
        request_mock.stub_request(
            "get", "/v1/myupdateables/foo", {"id": "foo", "bobble": "scrobble"}
        )

        res = self.MyUpdateable.retrieve("foo", xpay_version="2017-08-15")
