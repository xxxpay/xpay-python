...
class TestSearchableAPIResource(object):
    class MySearchable(xpay.api_resources.abstract.SearchableAPIResource):
    ...
    def test_search(self, request_mock):
        ...
        assert all(isinstance(obj, xpay.Charge) for obj in res.data)
    ...
    def test_search_multiple_pages(self, request_mock):
        ...
        assert all(isinstance(obj, xpay.Charge) for obj in res2.data)
