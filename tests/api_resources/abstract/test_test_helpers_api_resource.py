...
from xpay.api_resources.abstract import APIResourceTestHelpers


class TestTestHelperAPIResource(object):
    class MyTestHelpersResource(xpay.api_resources.abstract.APIResource):
        OBJECT_NAME = "myresource"

        @xpay.api_resources.abstract.custom_method(
