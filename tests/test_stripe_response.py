...
from xpay.xpay_response import XPayResponseBase, XPayResponse
...
class ResponseTestBase(object):
    ...
    def mock_response(self, mock_headers):
        ...
        response = XPayResponseBase(code, headers)
        return response
...
class TestXPayResponse(ResponseTestBase):
    ...
    def mock_response(self, mock_headers, mock_body):
        code = 200
        response = XPayResponse(mock_body, code, mock_headers)
        return response
