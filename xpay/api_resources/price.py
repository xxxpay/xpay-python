...
if TYPE_CHECKING:
    from xpay.api_resources.product import Product
...
class Price(
    ...
    class CurrencyOptions(XPayObject):
        class CustomUnitAmount(XPayObject):
    ...
    class Recurring(XPayObject):
        ...
        """
        Default number of trial days when subscribing a customer to this price using [`trial_from_plan=true`](https://xpay.com/docs/api#create_subscription-trial_from_plan).
        """
    ...
    class TransformQuantity(XPayObject):
        divide_by: int
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            Prices defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://xpay.com/docs/currencies).
            """
            custom_unit_amount: NotRequired[
                "Price.CreateParamsCustomUnitAmount"
            ]
            """
            When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
            """
            ...
            transform_quantity: NotRequired[
                "Price.CreateParamsTransformQuantity"
            ]
            """
        ...
        class SearchParams(RequestOptions):
            ...
            query: str
            """
            The search query string. See [search query language](https://xpay.com/docs/search#search-query-language) and the list of supported [query fields for prices](https://xpay.com/docs/search#query-fields-for-prices).
            """
    ...
    def search(
        ...
        """
        Search for prices you've previously created using XPay's [Search Query Language](https://xpay.com/docs/search#search-query-language).
