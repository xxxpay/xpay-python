...
if TYPE_CHECKING:
    ...
    from xpay.api_resources.terminal.location import Location
...
class Reader(
    ...
    Related guide: [Connecting to a reader](https://xpay.com/docs/terminal/payments/connect-reader)
    """

    OBJECT_NAME: ClassVar[Literal["terminal.reader"]] = "terminal.reader"

    class Action(XPayObject):
        class ProcessPaymentIntent(XPayObject):
            class ProcessConfig(XPayObject):
                class Tipping(XPayObject):
        ...
        class ProcessSetupIntent(XPayObject):
            class ProcessConfig(XPayObject):
                pass
        ...
        class RefundPayment(XPayObject):
            amount: Optional[int]
            """
        ...
        class SetReaderDisplay(XPayObject):
            class Cart(XPayObject):
                class LineItem(XPayObject):
                    amount: int
                    """
                    The amount of the line item. A positive integer in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal).
                    """
                    description: str
                    """
                ...
                tax: Optional[int]
                """
                Tax amount for the entire cart. A positive integer in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal).
                """
                total: int
                """
                Total amount for the entire cart, including tax. A positive integer in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal).
                """
    ...
    if TYPE_CHECKING:
        ...
        class ListParams(RequestOptions):
            device_type: NotRequired[
                "Literal['bbpos_chipper2x', 'bbpos_wisepad3', 'bbpos_wisepos_e', 'simulated_wisepos_e', 'xpay_m2', 'verifone_P400']"
            ]
            """
    ...
    """
    Type of reader, one of `bbpos_wisepad3`, `xpay_m2`, `bbpos_chipper2x`, `bbpos_wisepos_e`, `verifone_P400`, or `simulated_wisepos_e`.
    """
    id: str
    """
