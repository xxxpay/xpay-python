...
if TYPE_CHECKING:
    ...
    from xpay.api_resources.reversal import Reversal
...
class Transfer(
    ...
    """
    A `Transfer` object is created when you move funds between XPay accounts as
    part of Connect.

    Before April 6, 2017, transfers also represented movement of funds from a
    XPay account to a card or bank account. This behavior has since been split
    out into a [Payout](https://xpay.com/docs/api#payout_object) object, with corresponding payout endpoints. For more
    information, read about the
    [transfer/payout split](https://xpay.com/docs/transfer-payout-split).

    Related guide: [Creating separate charges and transfers](https://xpay.com/docs/connect/separate-charges-and-transfers)
    """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            currency: str
            """
            3-letter [ISO code for currency](https://xpay.com/docs/payouts).
            """
            ...
            destination: str
            """
            The ID of a connected XPay account. [See the Connect documentation](https://xpay.com/docs/connect/separate-charges-and-transfers) for details.
            """
            ...
            """
            A string that identifies this transaction as part of a group. See the [Connect documentation](https://xpay.com/docs/connect/separate-charges-and-transfers#transfer-options) for details.
            """
        ...
        class CreateReversalParams(RequestOptions):
            amount: NotRequired["int"]
            """
            A positive integer in cents (or local equivalent) representing how much of this transfer to reverse. Can only reverse up to the unreversed amount remaining of the transfer. Partial transfer reversals are only allowed for transfers to XPay Accounts. Defaults to the entire transfer amount.
            """
            description: NotRequired["str"]
            """
    ...
    """
    ID of the XPay account the transfer was sent to.
    """
    destination_payment: Optional[ExpandableField["Charge"]]
    """
    If the destination is a XPay account, this will be the ID of the payment that the destination account received for the transfer.
    """
    id: str
    """
    ...
    def create(
        ...
        **params: Unpack["Transfer.CreateParams"]
        ...
        """
        To send funds from your XPay account to a connected account, you create a new transfer object. Your [XPay balance](https://xpay.com/docs/api#balance) must be able to cover the transfer amount, or you'll receive an “Insufficient Funds” error.
        """
        return cast(
            "Transfer",
            cls._static_request(
    ...
    def retrieve(
        ...
        """
        Retrieves the details of an existing transfer. Supply the unique transfer ID from either a transfer creation request or the transfer list, and XPay will return the corresponding transfer information.
        """
