...
class TaxId(APIResource["TaxId"]):
    """
    You can add one or multiple tax IDs to a [customer](https://xpay.com/docs/api/customers) or account.
    Customer and account tax IDs get displayed on related invoices and credit notes.

    Related guides: [Customer tax identification numbers](https://xpay.com/docs/billing/taxes/tax-ids), [Account tax IDs](https://xpay.com/docs/invoicing/connect#account-tax-ids)
    """
