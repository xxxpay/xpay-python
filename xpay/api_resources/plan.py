...
class Plan(
    ...
    class TransformUsage(XPayObject):
        divide_by: int
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            id: NotRequired["str"]
            """
            An identifier randomly generated by XPay. Used to identify this plan when subscribing a customer. You can optionally override this ID, but the ID must be unique across all plans in your XPay account. You can, however, use the same plan ID in both live and test modes.
            """
            ...
            """
            Default number of trial days when subscribing a customer to this plan using [`trial_from_plan=true`](https://xpay.com/docs/api#create_subscription-trial_from_plan).
            """
