...
class CashBalance(XPayObject):
    ...
    """
    A hash of all cash balances available to this customer. You cannot delete a customer with any cash balances, even if the balance is 0. Amounts are represented in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal).
    """
    customer: str
    """
