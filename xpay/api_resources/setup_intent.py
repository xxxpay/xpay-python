...
class SetupIntent(
    ...
    class LastSetupError(XPayObject):
        charge: Optional[str]
        """
    ...
    class NextAction(XPayObject):
        ...
        """
        When confirming a SetupIntent with XPay.js, XPay.js depends on the contents of this dictionary to invoke authentication flows. The shape of the contents is subject to change and is only intended to be used by XPay.js.
        """
    ...
    class PaymentMethodOptions(XPayObject):
        class AcssDebit(XPayObject):
            class MandateOptions(XPayObject):
                ...
                """
                List of XPay products where this mandate can be selected automatically.
                """
    ...
    if TYPE_CHECKING:
        ...
        class ConfirmParams(RequestOptions):
            ...
            """
            When included, this hash creates a PaymentMethod that is set as the [`payment_method`](https://xpay.com/docs/api/setup_intents/object#setup_intent_object-payment_method)
        ...
        class ConfirmParamsPaymentMethodOptions(TypedDict):
            ...
            """
            link: NotRequired[
                "SetupIntent.ConfirmParamsPaymentMethodOptionsLink"
            ]
            """
        ...
        class ConfirmParamsPaymentMethodOptionsCardMandateOptions(TypedDict):
            ...
            currency: str
            """
            Currency in which future payments will be charged. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://xpay.com/docs/currencies).
            """
        ...
        class ConfirmParamsPaymentMethodData(TypedDict):
            ...
            """
            affirm: NotRequired[
                "SetupIntent.ConfirmParamsPaymentMethodDataAffirm"
            ]
            """
            ...
            """
            alipay: NotRequired[
                "SetupIntent.ConfirmParamsPaymentMethodDataAlipay"
            ]
            """
            ...
            """
            boleto: NotRequired[
                "SetupIntent.ConfirmParamsPaymentMethodDataBoleto"
            ]
            """
            ...
            """
            klarna: NotRequired[
                "SetupIntent.ConfirmParamsPaymentMethodDataKlarna"
            ]
            """
            ...
            """
            paynow: NotRequired[
                "SetupIntent.ConfirmParamsPaymentMethodDataPaynow"
            ]
            """
            ...
            """
            sofort: NotRequired[
                "SetupIntent.ConfirmParamsPaymentMethodDataSofort"
            ]
            """
        ...
        class ConfirmParamsPaymentMethodDataKlarna(TypedDict):
            dob: NotRequired[
                "SetupIntent.ConfirmParamsPaymentMethodDataKlarnaDob"
            ]
            """
        ...
        class CreateParams(RequestOptions):
            ...
            """
            If present, the SetupIntent's payment method will be attached to the in-context XPay Account.

            It can only be used for this XPay Account's own money movement flows like InboundTransfer and OutboundTransfers. It cannot be set to true when setting up a PaymentMethod for a Customer, and defaults to false when attaching a PaymentMethod to a Customer.
            """
            ...
            """
            This hash contains details about the mandate to create. This parameter can only be used with [`confirm=true`](https://xpay.com/docs/api/setup_intents/create#create_setup_intent-confirm).
            """
            metadata: NotRequired["Dict[str, str]"]
            """
            Set of [key-value pairs](https://xpay.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
            ...
            """
            The XPay account ID created for this SetupIntent.
            """
            payment_method: NotRequired["str"]
            """
            ID of the payment method (a PaymentMethod, Card, or saved Source object) to attach to this SetupIntent.
            ...
            return_url: NotRequired["str"]
            """
            The URL to redirect your customer back to after they authenticate or cancel their payment on the payment method's app or site. To redirect to a mobile application, you can alternatively supply an application URI scheme. This parameter can only be used with [`confirm=true`](https://xpay.com/docs/api/setup_intents/create#create_setup_intent-confirm).
            """
        ...
        class CreateParamsPaymentMethodOptions(TypedDict):
            ...
            """
            link: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodOptionsLink"
            ]
            """
            If this is a `link` PaymentMethod, this sub-hash contains details about the Link payment method options.
            """
        ...
        class CreateParamsPaymentMethodData(TypedDict):
            ...
            """
            alipay: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodDataAlipay"
            ]
            """
            If this is an `Alipay` PaymentMethod, this hash contains details about the Alipay payment method.
            """
            ...
            """
            boleto: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodDataBoleto"
            ]
            """
            If this is a `boleto` PaymentMethod, this hash contains details about the Boleto payment method.
            """
            ...
            """
            ideal: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodDataIdeal"
            ]
            """
            If this is an `ideal` PaymentMethod, this hash contains details about the iDEAL payment method.
            """
            ...
            """
            klarna: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodDataKlarna"
            ]
            """
            If this is a `klarna` PaymentMethod, this hash contains details about the Klarna payment method.
            """
            ...
            """
            paynow: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodDataPaynow"
            ]
            """
            If this is a `paynow` PaymentMethod, this hash contains details about the PayNow payment method.
            """
            paypal: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodDataPaypal"
            ]
            """
            If this is a `paypal` PaymentMethod, this hash contains details about the PayPal payment method.
            """
            ...
            """
            sofort: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodDataSofort"
            ]
            """
            If this is a `sofort` PaymentMethod, this hash contains details about the SOFORT payment method.
            """
        ...
        class CreateParamsPaymentMethodDataKlarna(TypedDict):
            dob: NotRequired[
                "SetupIntent.CreateParamsPaymentMethodDataKlarnaDob"
            ]
            """
            Customer's date of birth
            """
        ...
        class ModifyParamsPaymentMethodOptions(TypedDict):
            ...
            """
            card: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodOptionsCard"
            ]
            """
            Configuration for any card setup attempted on this SetupIntent.
            """
            link: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodOptionsLink"
            ]
            """
            If this is a `link` PaymentMethod, this sub-hash contains details about the Link payment method options.
            """
        ...
        class ModifyParamsPaymentMethodData(TypedDict):
            ...
            """
            affirm: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataAffirm"
            ]
            """
            If this is an `affirm` PaymentMethod, this hash contains details about the Affirm payment method.
            """
            ...
            """
            alipay: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataAlipay"
            ]
            """
            If this is an `Alipay` PaymentMethod, this hash contains details about the Alipay payment method.
            """
            ...
            """
            boleto: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataBoleto"
            ]
            """
            If this is a `boleto` PaymentMethod, this hash contains details about the Boleto payment method.
            """
            ...
            """
            ideal: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataIdeal"
            ]
            """
            If this is an `ideal` PaymentMethod, this hash contains details about the iDEAL payment method.
            """
            ...
            """
            klarna: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataKlarna"
            ]
            """
            If this is a `klarna` PaymentMethod, this hash contains details about the Klarna payment method.
            """
            ...
            """
            paynow: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataPaynow"
            ]
            """
            If this is a `paynow` PaymentMethod, this hash contains details about the PayNow payment method.
            """
            paypal: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataPaypal"
            ]
            """
            If this is a `paypal` PaymentMethod, this hash contains details about the PayPal payment method.
            """
            ...
            """
            sofort: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataSofort"
            ]
            """
            If this is a `sofort` PaymentMethod, this hash contains details about the SOFORT payment method.
            """
        ...
        class ModifyParamsPaymentMethodDataKlarna(TypedDict):
            dob: NotRequired[
                "SetupIntent.ModifyParamsPaymentMethodDataKlarnaDob"
            ]
            """
            Customer's date of birth
            """
    ...
    """
    [Status](https://xpay.com/docs/payments/intents#intent-statuses) of this SetupIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `canceled`, or `succeeded`.
    """
    usage: str
    """
    ...
    def create(
        ...
        **params: Unpack["SetupIntent.CreateParams"]
        ...
        After you create the SetupIntent, attach a payment method and [confirm](https://xpay.com/docs/api/setup_intents/confirm)
    ...
    def retrieve(
        ...
        When retrieved with a publishable key, only a subset of properties will be returned. Please refer to the [SetupIntent](https://xpay.com/docs/api#setup_intent_object) object reference for more details.
        """
