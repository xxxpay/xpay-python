...
if TYPE_CHECKING:
    from xpay.api_resources.credit_note_line_item import CreditNoteLineItem
    ...
    from xpay.api_resources.refund import Refund
...
class CreditNote(
    ...
    Related guide: [Credit notes](https://xpay.com/docs/billing/invoices/credit-notes)
    """

    OBJECT_NAME: ClassVar[Literal["credit_note"]] = "credit_note"

    class DiscountAmount(XPayObject):
        amount: int
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            The integer amount in cents (or local equivalent) representing the amount that is credited outside of XPay.
            """
            reason: NotRequired[
    ...
    """
    Amount that was credited outside of XPay.
    """
    pdf: str
    """
    ...
    """
    Status of this credit note, one of `issued` or `void`. Learn more about [voiding credit notes](https://xpay.com/docs/billing/invoices/credit-notes#voiding).
    """
    subtotal: int
    """
    ...
    def create(
        ...
        **params: Unpack["CreditNote.CreateParams"]
        ...
        Outside of XPay credit: record the amount that is or will be credited outside of XPay (using out_of_band_amount).


        For post-payment credit notes the sum of the refund, credit and outside of XPay amounts must equal the credit note total.
    ...
    def _cls_void_credit_note(
        ...
        **params: Unpack["CreditNote.VoidCreditNoteParams"]
        ...
        """
        Marks a credit note as void. Learn more about [voiding credit notes](https://xpay.com/docs/billing/invoices/credit-notes#voiding).
        """
        return cast(
            "CreditNote",
            cls._static_request(
