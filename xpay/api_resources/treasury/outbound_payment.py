...
class OutboundPayment(
    ...
    class DestinationPaymentMethodDetails(XPayObject):
    ...
    class EndUserDetails(XPayObject):
    ...
    class ReturnedDetails(XPayObject):
        code: Literal[
            "account_closed",
            "account_frozen",
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            The description that appears on the receiving end for this OutboundPayment (for example, bank statement for external bank transfer). Maximum 10 characters for `ach` payments, 140 characters for `wire` payments, or 500 characters for `xpay` network transfers. The default value is `payment`.
            """
    ...
    """
    ID of the [customer](https://xpay.com/docs/api/customers) to whom an OutboundPayment is sent.
    """
