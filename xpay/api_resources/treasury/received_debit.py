...
class ReceivedDebit(ListableAPIResource["ReceivedDebit"]):
    ...
    class LinkedFlows(XPayObject):
        ...
        """
        Set if the ReceivedDebit was created due to an [Issuing Authorization](https://xpay.com/docs/api#issuing_authorizations) object.
        """
        issuing_transaction: Optional[str]
        """
        Set if the ReceivedDebit is also viewable as an [Issuing Dispute](https://xpay.com/docs/api#issuing_disputes) object.
        """
