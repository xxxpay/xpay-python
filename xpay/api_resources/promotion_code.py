...
if TYPE_CHECKING:
    from xpay.api_resources.coupon import Coupon
...
class PromotionCode(
    ...
    """
    A Promotion Code represents a customer-redeemable code for a [coupon](https://xpay.com/docs/api#coupons). It can be used to
    create multiple codes for a single coupon.
    """

    OBJECT_NAME: ClassVar[Literal["promotion_code"]] = "promotion_code"

    class Restrictions(XPayObject):
        ...
        """
        Promotion code restrictions defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://xpay.com/docs/currencies).
        """
        ...
        """
        Three-letter [ISO code](https://xpay.com/docs/currencies) for minimum_amount
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParamsRestrictions(TypedDict):
            ...
            """
            Promotion codes defined in each available currency option. Each key must be a three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html) and a [supported currency](https://xpay.com/docs/currencies).
            """
    ...
    might want to apply to a customer. Coupons may be applied to [subscriptions](https://xpay.com/docs/api#subscriptions), [invoices](https://xpay.com/docs/api#invoices),
    [checkout sessions](https://xpay.com/docs/api/checkout/sessions), [quotes](https://xpay.com/docs/api#quotes), and more. Coupons do not work with conventional one-off [charges](https://xpay.com/docs/api#create_charge) or [payment intents](https://xpay.com/docs/api/payment_intents).
    """
    created: int
    """
    ...
    def retrieve(
        ...
        """
        Retrieves the promotion code with the given ID. In order to retrieve a promotion code by the customer-facing code use [list](https://xpay.com/docs/api/promotion_codes/list) with the desired code.
        """
