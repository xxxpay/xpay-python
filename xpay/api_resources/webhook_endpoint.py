...
class WebhookEndpoint(
    ...
    """
    You can configure [webhook endpoints](https://xpay.com/docs/webhooks/) via the API to be
    notified about events that happen in your XPay account or connected
    accounts.

    Most users configure webhooks from [the dashboard](https://dashboard.xpay.com/webhooks), which provides a user interface for registering and testing your webhook endpoints.

    Related guide: [Setting up webhooks](https://xpay.com/docs/webhooks/configure)
    """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            Events sent to this endpoint will be generated with this XPay Version instead of your account's default XPay Version.
            """
    ...
    secret: Optional[str]
    """
    The endpoint's secret, used to generate [webhook signatures](https://xpay.com/docs/webhooks/signatures). Only returned at creation.
    """
    status: str
    """
    ...
    def create(
        ...
        **params: Unpack["WebhookEndpoint.CreateParams"]
        ...
        """
        A webhook endpoint must have a url and a list of enabled_events. You may optionally specify the Boolean connect parameter. If set to true, then a Connect webhook endpoint that notifies the specified url about events from all connected accounts is created; otherwise an account webhook endpoint that notifies the specified url only about events from your account is created. You can also create webhook endpoints in the [webhooks settings](https://dashboard.xpay.com/account/webhooks) section of the Dashboard.
        """
        return cast(
            "WebhookEndpoint",
            cls._static_request(
    ...
    def _cls_delete(
        ...
        """
        You can also delete webhook endpoints via the [webhook endpoint management](https://dashboard.xpay.com/account/webhooks) page of the XPay dashboard.
        """
