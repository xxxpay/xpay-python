...
class Capability(UpdateableAPIResource["Capability"]):
    """
    This is an object representing a capability for a XPay account.

    Related guide: [Account capabilities](https://xpay.com/docs/connect/account-capabilities)
    """
    ...
    class Requirements(XPayObject):
        ...
        - [Afterpay Clearpay's terms of service](https://xpay.com/afterpay-clearpay/legal#restricted-businesses)

        If you believe that the rejection is in error, please contact support at https://support.xpay.com/contact/ for assistance.
        """
        errors: List[Error]
        """
        Fields that are `currently_due` and need to be collected again because validation or verification failed.
