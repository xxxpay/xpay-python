...
if TYPE_CHECKING:
    from xpay.api_resources.radar.value_list_item import ValueListItem
...
class ValueList(
    ...
    Related guide: [Default XPay lists](https://xpay.com/docs/radar/lists#managing-list-items)
    """
