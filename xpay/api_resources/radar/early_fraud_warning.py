...
class EarlyFraudWarning(ListableAPIResource["EarlyFraudWarning"]):
    ...
    Related guide: [Early fraud warnings](https://xpay.com/docs/disputes/measuring#early-fraud-warnings)
    """
    ...
    def retrieve(
        ...
        Please refer to the [early fraud warning](https://xpay.com/docs/api#early_fraud_warning_object) object reference for more details.
        """
