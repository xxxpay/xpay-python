...
class AccountLink(CreateableAPIResource["AccountLink"]):
    ...
    XPay-hosted applications, such as Connect Onboarding.

    Related guide: [Connect Onboarding](https://xpay.com/docs/connect/custom/hosted-onboarding)
    """
    ...
    def create(
        ...
        **params: Unpack["AccountLink.CreateParams"]
        ...
        """
        Creates an AccountLink object that includes a single-use XPay URL that the platform can redirect their user to in order to take them through the Connect Onboarding flow.
        """
        return cast(
            "AccountLink",
            cls._static_request(
