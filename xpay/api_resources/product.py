...
class Product(
    ...
    They can be used in conjunction with [Prices](https://xpay.com/docs/api#prices) to configure pricing in Payment Links, Checkout, and Subscriptions.

    Related guides: [Set up a subscription](https://xpay.com/docs/billing/subscriptions/set-up-subscription),
    [share a Payment Link](https://xpay.com/docs/payment-links),
    [accept payments with Checkout](https://xpay.com/docs/payments/accept-a-payment#create-product-prices-upfront),
    and more about [Products and Prices](https://xpay.com/docs/products-prices/overview)
    """

    OBJECT_NAME: ClassVar[Literal["product"]] = "product"

    class Feature(XPayObject):
        name: Optional[str]
        """
        The feature's name. Up to 80 characters long.
        """

    class PackageDimensions(XPayObject):
        height: float
        """
        Height, in inches.
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            default_price_data: NotRequired[
                "Product.CreateParamsDefaultPriceData"
            ]
            """
            Data used to generate a new [Price](https://xpay.com/docs/api/prices) object. This Price will be set as the default price for this product.
            """
            ...
            """
            A list of up to 15 features for this product. These are displayed in [pricing tables](https://xpay.com/docs/payments/checkout/pricing-table).
            """
            id: NotRequired["str"]
            """
            An identifier will be randomly generated by XPay. You can optionally override this ID, but the ID must be unique across all products in your XPay account.
            """
        ...
        class CreateParamsDefaultPriceData(TypedDict):
            ...
            recurring: NotRequired[
                "Product.CreateParamsDefaultPriceDataRecurring"
            ]
            """
        ...
        class ListParams(RequestOptions):
            ...
            """
            Only return products with the given IDs. Cannot be used with [starting_after](https://xpay.com/docs/api#list_products-starting_after) or [ending_before](https://xpay.com/docs/api#list_products-ending_before).
            """
        ...
        class ModifyParams(RequestOptions):
            ...
            """
            The ID of the [Price](https://xpay.com/docs/api/prices) object that is the default price for this product.
            """
            ...
            features: NotRequired[
                "Literal['']|List[Product.ModifyParamsFeature]"
            ]
            """
            A list of up to 15 features for this product. These are displayed in [pricing tables](https://xpay.com/docs/payments/checkout/pricing-table).
            """
        ...
        class SearchParams(RequestOptions):
            ...
            query: str
            """
            The search query string. See [search query language](https://xpay.com/docs/search#search-query-language) and the list of supported [query fields for products](https://xpay.com/docs/search#query-fields-for-products).
            """
    ...
    def retrieve(
        ...
        """
        Retrieves the details of an existing product. Supply the unique product ID from either a product creation request or the product list, and XPay will return the corresponding product information.
        """
    ...
    def search(
        ...
        """
        Search for products you've previously created using XPay's [Search Query Language](https://xpay.com/docs/search#search-query-language).
