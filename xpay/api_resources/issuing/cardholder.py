...
if TYPE_CHECKING:
    from xpay.api_resources.file import File
...
class Cardholder(
    ...
    """
    An Issuing `Cardholder` object represents an individual or business entity who is [issued](https://xpay.com/docs/issuing) cards.

    Related guide: [How to create a cardholder](https://xpay.com/docs/issuing/cards#create-cardholder)
    """

    OBJECT_NAME: ClassVar[Literal["issuing.cardholder"]] = "issuing.cardholder"

    class Billing(XPayObject):
    ...
    class Company(XPayObject):
        tax_id_provided: bool
        """
        Whether the company's business ID number was provided.
        """

    class Individual(XPayObject):
        class CardIssuing(XPayObject):
            class UserTermsAcceptance(XPayObject):
                date: Optional[int]
                """
            ...
            """
            Information about cardholder acceptance of [Authorized User Terms](https://xpay.com/docs/issuing/cards).
            """
        ...
        class Verification(XPayObject):
            class Document(XPayObject):
                back: Optional[ExpandableField["File"]]
                """
                The back of a document returned by a [file upload](https://xpay.com/docs/api#create_file) with a `purpose` value of `identity_document`.
                """
                front: Optional[ExpandableField["File"]]
                """
                The front of a document returned by a [file upload](https://xpay.com/docs/api#create_file) with a `purpose` value of `identity_document`.
                """
    ...
    class SpendingControls(XPayObject):
        class SpendingLimit(XPayObject):
            amount: int
            """
            Maximum amount allowed to spend per interval. This amount is in the card's currency and in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal).
            """
            categories: Optional[
                List[
                    Literal[
            ...
            """
            Array of strings containing [categories](https://xpay.com/docs/api#issuing_authorization_object-merchant_data-category) this limit applies to. Omitting this field will apply the limit to all categories.
            """
            interval: Literal[
                "all_time",
                "daily",
        ...
        """
        Array of strings containing [categories](https://xpay.com/docs/api#issuing_authorization_object-merchant_data-category) of authorizations to allow. All other categories will be blocked. Cannot be set with `blocked_categories`.
        """
        ...
        """
        Array of strings containing [categories](https://xpay.com/docs/api#issuing_authorization_object-merchant_data-category) of authorizations to decline. All other categories will be allowed. Cannot be set with `allowed_categories`.
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            The cardholder's preferred locales (languages), ordered by preference. Locales can be `de`, `en`, `es`, `fr`, or `it`.
             This changes the language of the [3D Secure flow](https://xpay.com/docs/issuing/3d-secure) and one-time password messages sent to the cardholder.
            """
            spending_controls: NotRequired[
                "Cardholder.CreateParamsSpendingControls"
            ]
            """
            Rules that control spending across this cardholder's cards. Refer to our [documentation](https://xpay.com/docs/issuing/controls/spending-controls) for more details.
            """
            ...
            """
            One of `individual` or `company`. See [Choose a cardholder type](https://xpay.com/docs/issuing/other/choose-cardholder) for more details.
            """
        ...
        class CreateParamsIndividualVerificationDocument(TypedDict):
            ...
            """
            The back of an ID returned by a [file upload](https://xpay.com/docs/api#create_file) with a `purpose` value of `identity_document`.
            """
            front: NotRequired["str"]
            """
            The front of an ID returned by a [file upload](https://xpay.com/docs/api#create_file) with a `purpose` value of `identity_document`.
            """
        ...
        class ModifyParams(RequestOptions):
            ...
            phone_number: NotRequired["str"]
            """
            The cardholder's phone number. This is required for all cardholders who will be creating EU cards. See the [3D Secure documentation](https://xpay.com/docs/issuing/3d-secure) for more details.
            """
            preferred_locales: NotRequired[
                "List[Literal['de', 'en', 'es', 'fr', 'it']]"
            ]
    ...
    """
    The cardholder's phone number. This is required for all cardholders who will be creating EU cards. See the [3D Secure documentation](https://xpay.com/docs/issuing/3d-secure#when-is-3d-secure-applied) for more details.
    """
