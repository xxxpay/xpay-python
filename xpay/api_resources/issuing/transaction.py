...
if TYPE_CHECKING:
    ...
    from xpay.api_resources.issuing.authorization import Authorization
    from xpay.api_resources.issuing.card import Card
    from xpay.api_resources.issuing.cardholder import Cardholder
    from xpay.api_resources.issuing.dispute import Dispute
...
class Transaction(
    ...
    """
    Any use of an [issued card](https://xpay.com/docs/issuing) that results in funds entering or leaving
    your XPay account, such as a completed purchase or refund, is represented by an Issuing
    `Transaction` object.

    Related guide: [Issued card transactions](https://xpay.com/docs/issuing/purchases/transactions)
    """
    ...
    class PurchaseDetails(XPayObject):
        class Flight(XPayObject):
            class Segment(XPayObject):
    ...
    class Treasury(XPayObject):
        ...
        """
        The Treasury [ReceivedCredit](https://xpay.com/docs/api/treasury/received_credits) representing this Issuing transaction if it is a refund
        """
        received_debit: Optional[str]
        """
        The Treasury [ReceivedDebit](https://xpay.com/docs/api/treasury/received_debits) representing this Issuing transaction if it is a capture
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateForceCaptureParams(RequestOptions):
            amount: int
            """
            The total amount to attempt to capture. This amount is in the provided currency, or defaults to the cards currency, and in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal).
            """
            card: str
            """
            ...
            """
            The currency of the capture. If not provided, defaults to the currency of the card. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://xpay.com/docs/currencies).
            """
            expand: NotRequired["List[str]"]
            """
            Specifies which fields in the response should be expanded.
        ...
        class CreateForceCaptureParamsPurchaseDetailsFlight(TypedDict):
            ...
            segments: NotRequired[
                "List[Transaction.CreateForceCaptureParamsPurchaseDetailsFlightSegment]"
            ]
            """
            The legs of the trip.
            """
        ...
        class CreateUnlinkedRefundParams(RequestOptions):
            amount: int
            """
            The total amount to attempt to refund. This amount is in the provided currency, or defaults to the cards currency, and in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal).
            """
            card: str
            """
            ...
            currency: NotRequired["str"]
            """
            The currency of the unlinked refund. If not provided, defaults to the currency of the card. Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://xpay.com/docs/currencies).
            """
            expand: NotRequired["List[str]"]
            """
            Specifies which fields in the response should be expanded.
    ...
    amount: int
    """
    The transaction amount, which will be reflected in your balance. This amount is in your currency and in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal).
    """
    ...
    """
    ID of the [balance transaction](https://xpay.com/docs/api/balance_transactions) associated with this transaction.
    """
    ...
    merchant_amount: int
    """
    The amount that the merchant will receive, denominated in `merchant_currency` and in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal). It will be different from `amount` if the merchant is taking payment in a different currency.
    """
    ...
    """
    [Token](https://xpay.com/docs/api/issuing/tokens/object) object used for this transaction. If a network token was not used for this transaction, this field will be null.
    """
    treasury: Optional[Treasury]
    """
    [Treasury](https://xpay.com/docs/api/treasury) details related to this transaction if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
    """
