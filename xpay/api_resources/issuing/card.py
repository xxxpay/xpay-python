...
class Card(
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            The [Cardholder](https://xpay.com/docs/api#issuing_cardholder_object) object with which the card will be associated.
            """
            currency: str
            """
            ...
            """
            Rules that control spending for this card. Refer to our [documentation](https://xpay.com/docs/issuing/controls/spending-controls) for more details.
            """
        ...
        class ModifyParamsPin(TypedDict):
            ...
            """
            The card's desired new PIN, encrypted under XPay's public key.
            """
    ...
    cvc: Optional[str]
    """
    The card's CVC. For security reasons, this is only available for virtual cards, and will be omitted unless you explicitly request it with [the `expand` parameter](https://xpay.com/docs/api/expanding_objects). Additionally, it's only available via the ["Retrieve a card" endpoint](https://xpay.com/docs/api/issuing/cards/retrieve), not via "List all cards" or any other endpoint.
    """
    exp_month: int
    """
    ...
    number: Optional[str]
    """
    The full unredacted card number. For security reasons, this is only available for virtual cards, and will be omitted unless you explicitly request it with [the `expand` parameter](https://xpay.com/docs/api/expanding_objects). Additionally, it's only available via the ["Retrieve a card" endpoint](https://xpay.com/docs/api/issuing/cards/retrieve), not via "List all cards" or any other endpoint.
    """
