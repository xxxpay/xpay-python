...
if TYPE_CHECKING:
    ...
    from xpay.api_resources.tax_id import TaxId
...
class PaymentLink(
    ...
    When a customer opens a payment link it will open a new [checkout session](https://xpay.com/docs/api/checkout/sessions) to render the payment page. You can use [checkout session events](https://xpay.com/docs/api/events/types#event_types-checkout.session.completed) to track payments through payment links.

    Related guide: [Payment Links API](https://xpay.com/docs/payment-links)
    """

    OBJECT_NAME: ClassVar[Literal["payment_link"]] = "payment_link"

    class AfterCompletion(XPayObject):
        class HostedConfirmation(XPayObject):
            custom_message: Optional[str]
            """
            The custom message that is displayed to the customer after the purchase is complete.
            """

        class Redirect(XPayObject):
            url: str
            """
    ...
    class PaymentIntentData(XPayObject):
        ...
        """
        Set of [key-value pairs](https://xpay.com/docs/api/metadata) that will set metadata on [Payment Intents](https://xpay.com/docs/api/payment_intents) generated from this payment link.
        """
    ...
    class SubscriptionData(XPayObject):
        description: Optional[str]
        """
        ...
        metadata: Dict[str, str]
        """
        Set of [key-value pairs](https://xpay.com/docs/api/metadata) that will set metadata on [Subscriptions](https://xpay.com/docs/api/subscriptions) generated from this payment link.
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's XPay account. Can only be applied when there are no line items with recurring prices.
            """
            application_fee_percent: NotRequired["float"]
            """
            A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice total that will be transferred to the application owner's XPay account. There must be at least 1 line item with a recurring price to use this field.
            """
            ...
            """
            Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://xpay.com/docs/currencies) and supported by each line item's price.
            """
            custom_fields: NotRequired[
                "List[PaymentLink.CreateParamsCustomField]"
            ]
            """
            ...
            """
            Configures whether [checkout sessions](https://xpay.com/docs/api/checkout/sessions) created by this payment link create a [Customer](https://xpay.com/docs/api/customers).
            """
            ...
            """
            Set of [key-value pairs](https://xpay.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`. Metadata associated with this Payment Link will automatically be copied to [checkout sessions](https://xpay.com/docs/api/checkout/sessions) created by this payment link.
            """
            ...
            """
            The list of payment method types that customers can use. If no value is passed, XPay will dynamically show relevant payment methods from your [payment method settings](https://dashboard.xpay.com/settings/payment_methods) (20+ payment methods [supported](https://xpay.com/docs/payments/payment-methods/integration-options#payment-method-product-support)).
            """
            ...
            """
            The shipping rate options to apply to [checkout sessions](https://xpay.com/docs/api/checkout/sessions) created by this payment link.
            """
            submit_type: NotRequired[
                "Literal['auto', 'book', 'donate', 'pay']"
            ]
            """
            Describes the type of transaction being performed in order to customize relevant text on the page, such as the submit button. Changing this value will also affect the hostname in the [url](https://xpay.com/docs/api/payment_links/payment_links/object#url) property (example: `donate.xpay.com`).
            """
        ...
        class CreateParamsSubscriptionData(TypedDict):
            ...
            metadata: NotRequired["Dict[str, str]"]
            """
            Set of [key-value pairs](https://xpay.com/docs/api/metadata) that will declaratively set metadata on [Subscriptions](https://xpay.com/docs/api/subscriptions) generated from this payment link. Unlike object-level metadata, this field is declarative. Updates will clear prior values.
            """
        ...
        class CreateParamsPaymentIntentData(TypedDict):
            ...
            metadata: NotRequired["Dict[str, str]"]
            """
            Set of [key-value pairs](https://xpay.com/docs/api/metadata) that will declaratively set metadata on [Payment Intents](https://xpay.com/docs/api/payment_intents) generated from this payment link. Unlike object-level metadata, this field is declarative. Updates will clear prior values.
            """
            setup_future_usage: NotRequired[
                "Literal['off_session', 'on_session']"
            ]
            """
            Indicates that you intend to [make future payments](https://xpay.com/docs/payments/payment-intents#future-usage) with the payment method collected by this Checkout Session.
        ...
        class CreateParamsLineItem(TypedDict):
            ...
            price: str
            """
            The ID of the [Price](https://xpay.com/docs/api/prices) or [Plan](https://xpay.com/docs/api/plans) object.
            """
            quantity: int
            """
        ...
        class CreateParamsCustomField(TypedDict):
            dropdown: NotRequired[
                "PaymentLink.CreateParamsCustomFieldDropdown"
            ]
            """
        ...
        class CreateParamsAfterCompletionRedirect(TypedDict):
            url: str
            """
            The URL the customer will be redirected to after the purchase is complete. You can embed `{CHECKOUT_SESSION_ID}` into the URL to have the `id` of the completed [checkout session](https://xpay.com/docs/api/checkout/sessions/object#checkout_session_object-id) included.
            """
        ...
        class ModifyParams(RequestOptions):
            ...
            """
            The list of payment method types that customers can use. Pass an empty string to enable dynamic payment methods that use your [payment method settings](https://dashboard.xpay.com/settings/payment_methods).
            """
            shipping_address_collection: NotRequired[
        ...
        class ModifyParamsCustomField(TypedDict):
            dropdown: NotRequired[
                "PaymentLink.ModifyParamsCustomFieldDropdown"
            ]
            """
            Configuration for `type=dropdown` fields.
            """
    ...
    """
    The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's XPay account.
    """
    application_fee_percent: Optional[float]
    """
    This represents the percentage of the subscription invoice total that will be transferred to the application owner's XPay account.
    """
    ...
    """
    The account on behalf of which to charge. See the [Connect documentation](https://support.xpay.com/questions/sending-invoices-on-behalf-of-connected-accounts) for details.
    """
    ...
    """
    The list of payment method types that customers can use. When `null`, XPay will dynamically show relevant payment methods you've enabled in your [payment method settings](https://dashboard.xpay.com/settings/payment_methods).
    """
