...
if TYPE_CHECKING:
    ...
    from xpay.api_resources.card import Card
    from xpay.api_resources.cash_balance import CashBalance
    ...
    from xpay.api_resources.funding_instructions import FundingInstructions
...
class Customer(
    ...
    Related guide: [Save a card during payment](https://xpay.com/docs/payments/save-during-payment)
    """
    ...
    class Tax(XPayObject):
        class Location(XPayObject):
            country: str
            """
            The customer's country as identified by XPay Tax.
            """
            source: Literal[
                "billing_address",
                "ip_address",
            ...
            state: Optional[str]
            """
            The customer's state, county, province, or region as identified by XPay Tax.
            """
        ...
        """
        The customer's location as identified by XPay Tax.
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            invoice_settings: NotRequired[
                "Customer.CreateParamsInvoiceSettings"
            ]
            """
        ...
        class CreateParamsTax(TypedDict):
            ...
            """
            A recent IP address of the customer used for tax reporting and tax location inference. XPay recommends updating the IP address when a new PaymentMethod is attached or the address field on the customer is updated. We recommend against updating this field more frequently since it could result in unexpected tax location/reporting outcomes.
            """
        ...
        class CreateParamsCashBalanceSettings(TypedDict):
            ...
            """
            Controls how funds transferred by the customer are applied to payment intents and invoices. Valid options are `automatic`, `manual`, or `merchant_default`. For more information about these reconciliation modes, see [Reconciliation](https://xpay.com/docs/payments/customer-balance/reconciliation).
            """
        ...
        class ModifyParams(RequestOptions):
            ...
            """
            If you are using payment methods created via the PaymentMethods API, see the [invoice_settings.default_payment_method](https://xpay.com/docs/api/customers/update#update_customer-invoice_settings-default_payment_method) parameter.

            Provide the ID of a payment source already attached to this customer to make it this customer's default payment source.

            If you want to add a new payment source and make it the default, see the [source](https://xpay.com/docs/api/customers/update#update_customer-source) property.
            """
            description: NotRequired["str"]
            """
            An arbitrary string that you can attach to a customer object. It is displayed alongside the customer in the dashboard.
            ...
            """
            invoice_settings: NotRequired[
                "Customer.ModifyParamsInvoiceSettings"
            ]
            """
            Default invoice settings for this customer.
            """
        ...
        class SearchParams(RequestOptions):
            ...
            query: str
            """
            The search query string. See [search query language](https://xpay.com/docs/search#search-query-language) and the list of supported [query fields for customers](https://xpay.com/docs/search#query-fields-for-customers).
            """
        ...
        class FundCashBalanceParams(RequestOptions):
            amount: int
            """
            Amount to be used for this test cash balance transaction. A positive integer representing how much to fund in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal) (e.g., 100 cents to fund $1.00 or 100 to fund ¥100, a zero-decimal currency).
            """
            currency: str
            """
            Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://xpay.com/docs/currencies).
            ...
            """
            A description of the test funding. This simulates free-text references supplied by customers when making bank transfers to their cash balance. You can use this to test how XPay's [reconciliation algorithm](https://xpay.com/docs/payments/customer-balance/reconciliation) applies to different user inputs.
            """
        ...
        class CreateBalanceTransactionParams(RequestOptions):
            ...
            currency: str
            """
            Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://xpay.com/docs/currencies). Specifies the [`invoice_credit_balance`](https://xpay.com/docs/api/customers/object#customer_object-invoice_credit_balance) that this transaction will apply to. If the customer's `currency` is not set, it will be updated to this value.
            """
            description: NotRequired["str"]
            """
        ...
        class CreateSourceParams(RequestOptions):
            ...
            source: str
            """
            Please refer to full [documentation](https://xpay.com/docs/api) instead.
            """
            validate: NotRequired["bool"]
    ...
    """
    The current balance, if any, that's stored on the customer. If negative, the customer has credit to apply to their next invoice. If positive, the customer has an amount owed that's added to their next invoice. The balance only considers amounts that XPay hasn't successfully applied to any invoice. It doesn't reflect unpaid invoices. This balance is only taken into account after invoices finalize.
    """
    cash_balance: Optional["CashBalance"]
    """
    The current funds being held by XPay on behalf of the customer. You can apply these funds towards payment intents when the source is "cash_balance". The `settings[reconciliation_mode]` field describes if these funds apply to these payment intents manually or automatically.
    """
    created: int
    """
    ...
    """
    Three-letter [ISO code for the currency](https://xpay.com/docs/currencies) the customer can be charged in for recurring billing purposes.
    """
    ...
    If you use payment methods created through the PaymentMethods API, see the [invoice_settings.default_payment_method](https://xpay.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method) field instead.
    """
    delinquent: Optional[bool]
    """
    Tracks the most recent state change on any invoice belonging to the customer. Paying an invoice or marking it uncollectible via the API will set this field to false. An automatic payment failure or passing the `invoice.due_date` will set this field to `true`.

    If an invoice becomes uncollectible by [dunning](https://xpay.com/docs/billing/automatic-collection), `delinquent` doesn't reset to `false`.
    ...
    """
    The current multi-currency balances, if any, that's stored on the customer. If positive in a currency, the customer has a credit to apply to their next invoice denominated in that currency. If negative, the customer has an amount owed that's added to their next invoice denominated in that currency. These balances don't apply to unpaid invoices. They solely track amounts that XPay hasn't successfully applied to any invoice. XPay only applies a balance in a specific currency to an invoice after that invoice (which is in the same currency) finalizes.
    """
    ...
    def search(
        ...
        """
        Search for customers you've previously created using XPay's [Search Query Language](https://xpay.com/docs/search#search-query-language).
    ...
    def create_balance_transaction(
        ...
        **params: Unpack["Customer.CreateBalanceTransactionParams"]
        ...
        """
        Creates an immutable transaction that updates the customer's credit [balance](https://xpay.com/docs/billing/customer/balance).
        """
        return cast(
            "CustomerBalanceTransaction",
            cls._static_request(
    ...
    def retrieve_balance_transaction(
        ...
        **params: Unpack["Customer.RetrieveBalanceTransactionParams"]
        ...
        """
        Retrieves a specific customer balance transaction that updated the customer's [balances](https://xpay.com/docs/billing/customer/balance).
        """
        return cast(
            "CustomerBalanceTransaction",
            cls._static_request(
    ...
    def list_balance_transactions(
        ...
        **params: Unpack["Customer.ListBalanceTransactionsParams"]
        ...
        """
        Returns a list of transactions that updated the customer's [balances](https://xpay.com/docs/billing/customer/balance).
        """
        return cast(
            ListObject["CustomerBalanceTransaction"],
            cls._static_request(
    ...
    def retrieve_cash_balance_transaction(
        ...
        **params: Unpack["Customer.RetrieveCashBalanceTransactionParams"]
        ...
        """
        Retrieves a specific cash balance transaction, which updated the customer's [cash balance](https://xpay.com/docs/payments/customer-balance).
        """
        return cast(
            "CustomerCashBalanceTransaction",
            cls._static_request(
    ...
    def list_cash_balance_transactions(
        ...
        **params: Unpack["Customer.ListCashBalanceTransactionsParams"]
        ...
        """
        Returns a list of transactions that modified the customer's [cash balance](https://xpay.com/docs/payments/customer-balance).
        """
        return cast(
            ListObject["CustomerCashBalanceTransaction"],
            cls._static_request(
    ...
    def create_source(
        ...
        **params: Unpack["Customer.CreateSourceParams"]
        ...
        To change the default, you should [update the customer](https://xpay.com/docs/api#update_customer) to have a new default_source.
        """
        return cast(
            Union["Account", "BankAccount", "Card", "Source"],
            cls._static_request(
