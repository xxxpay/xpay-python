...
class Dispute(
    ...
    Related guide: [Disputes and fraud](https://xpay.com/docs/disputes)
    """

    OBJECT_NAME: ClassVar[Literal["dispute"]] = "dispute"

    class Evidence(XPayObject):
        ...
        """
        (ID of a [file upload](https://xpay.com/docs/guides/file-upload)) Your subscription cancellation policy, as shown to the customer.
        """
        ...
        """
        (ID of a [file upload](https://xpay.com/docs/guides/file-upload)) Any communication with the customer that you feel is relevant to your case. Examples include emails proving that the customer received the product or service, or demonstrating their use of or satisfaction with the product or service.
        """
        ...
        """
        (ID of a [file upload](https://xpay.com/docs/guides/file-upload)) A relevant document or contract showing the customer's signature.
        """
        duplicate_charge_documentation: Optional[ExpandableField["File"]]
        """
        (ID of a [file upload](https://xpay.com/docs/guides/file-upload)) Documentation for the prior charge that can uniquely identify the charge, such as a receipt, shipping label, work order, etc. This document should be paired with a similar document from the disputed payment that proves the two payments are separate.
        """
        ...
        """
        The XPay ID for the prior charge which appears to be a duplicate of the disputed charge.
        """
        ...
        """
        (ID of a [file upload](https://xpay.com/docs/guides/file-upload)) Any receipt or message sent to the customer notifying them of the charge.
        """
        refund_policy: Optional[ExpandableField["File"]]
        """
        (ID of a [file upload](https://xpay.com/docs/guides/file-upload)) Your refund policy, as shown to the customer.
        """
        ...
        """
        (ID of a [file upload](https://xpay.com/docs/guides/file-upload)) Documentation showing proof that a service was provided to the customer. This could include a copy of a signed contract, work order, or other form of written agreement.
        """
        ...
        """
        (ID of a [file upload](https://xpay.com/docs/guides/file-upload)) Any additional evidence or statements.
        """
    ...
    class EvidenceDetails(XPayObject):
        due_by: Optional[int]
        """
    ...
    class PaymentMethodDetails(XPayObject):
        class Card(XPayObject):
            ...
            """
            The card network's specific dispute reason code, which maps to one of XPay's primary dispute categories to simplify response guidance. The [Network code map](https://xpay.com/docs/disputes/categories#network-code-map) lists all available dispute reason codes by network.
            """
    ...
    """
    List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your XPay account as a result of this dispute.
    """
    ...
    """
    If true, it's still possible to refund the disputed payment. After the payment has been fully refunded, no further funds are withdrawn from your XPay account as a result of this dispute.
    """
    livemode: bool
    """
    ...
    def modify(
        ...
        """
        When you get a dispute, contacting your customer is always the best first step. If that doesn't work, you can submit evidence to help us resolve the dispute in your favor. You can do this in your [dashboard](https://dashboard.xpay.com/disputes), but if you prefer, you can use the API to submit evidence programmatically.

        Depending on your dispute type, different evidence fields will give you a better chance of winning your dispute. To figure out which evidence fields to provide, see our [guide to dispute types](https://xpay.com/docs/disputes/categories).
        """
