...
class Configuration(
    ...
    class BusinessProfile(XPayObject):
    ...
    class Features(XPayObject):
        class CustomerUpdate(XPayObject):
        ...
        class InvoiceHistory(XPayObject):
            enabled: bool
            """
            Whether the feature is enabled.
            """

        class PaymentMethodUpdate(XPayObject):
            enabled: bool
            """
            Whether the feature is enabled.
            """

        class SubscriptionCancel(XPayObject):
            class CancellationReason(XPayObject):
                enabled: bool
                """
                Whether the feature is enabled.
                """
        ...
        class SubscriptionPause(XPayObject):
            enabled: bool
            """
            Whether the feature is enabled.
            """

        class SubscriptionUpdate(XPayObject):
            class Product(XPayObject):
                prices: List[str]
                """
    ...
    class LoginPage(XPayObject):
        ...
        url: Optional[str]
        """
        A shareable URL to the hosted portal login page. Your customers will be able to log in with their [email](https://xpay.com/docs/api/customers/object#customer_object-email) and receive a link to their customer portal.
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            The default URL to redirect customers to when they click on the portal's link to return to your website. This can be [overriden](https://xpay.com/docs/api/customer_portal/sessions/create#create_portal_session-return_url) when creating the session.
            """
            ...
            """
            The hosted login page for this configuration. Learn more about the portal login page in our [integration docs](https://xpay.com/docs/billing/subscriptions/integrating-customer-portal#share).
            """
        ...
        class CreateParamsLoginPage(TypedDict):
            enabled: bool
            """
            Set to `true` to generate a shareable URL [`login_page.url`](https://xpay.com/docs/api/customer_portal/configuration#portal_configuration_object-login_page-url) that will take your customers to a hosted login page for the customer portal.
            """
