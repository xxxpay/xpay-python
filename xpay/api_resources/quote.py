...
class Quote(
    ...
    class Computed(XPayObject):
        class Recurring(XPayObject):
    ...
    class InvoiceSettings(XPayObject):
        days_until_due: Optional[int]
        """
        Number of days within which a customer must pay invoices generated by this quote. This value will be `null` for quotes where `collection_method=charge_automatically`.
        """

    class StatusTransitions(XPayObject):
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's XPay account. There cannot be any line items with recurring prices when using this field.
            """
            ...
            """
            Either `charge_automatically`, or `send_invoice`. When charging automatically, XPay will attempt to pay invoices at the end of the subscription cycle or at invoice finalization using the default payment method attached to the subscription or customer. When sending an invoice, XPay will email your customer an invoice with payment instructions and mark the subscription as `active`. Defaults to `charge_automatically`.
            """
            ...
            """
            A description that will be displayed on the quote PDF. If no value is passed, the default description configured in your [quote template settings](https://dashboard.xpay.com/settings/billing/quote) will be used.
            """
            ...
            """
            A future timestamp on which the quote will be canceled if in `open` or `draft` status. Measured in seconds since the Unix epoch. If no value is passed, the default expiration date configured in your [quote template settings](https://dashboard.xpay.com/settings/billing/quote) will be used.
            """
            footer: NotRequired["Literal['']|str"]
            """
            A footer that will be displayed on the quote PDF. If no value is passed, the default footer configured in your [quote template settings](https://dashboard.xpay.com/settings/billing/quote) will be used.
            """
            ...
            """
            A header that will be displayed on the quote PDF. If no value is passed, the default header configured in your [quote template settings](https://dashboard.xpay.com/settings/billing/quote) will be used.
            """
        ...
        class CreateParamsAutomaticTax(TypedDict):
            enabled: bool
            """
            Controls whether XPay will automatically compute tax on the resulting invoices or subscriptions as well as the quote itself.
            """
    ...
    """
    The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's XPay account. Only applicable if there are no line items with recurring prices on the quote.
    """
    application_fee_percent: Optional[float]
    """
    A non-negative decimal between 0 and 100, with at most two decimal places. This represents the percentage of the subscription invoice total that will be transferred to the application owner's XPay account. Only applicable if there are line items with recurring prices on the quote.
    """
    automatic_tax: AutomaticTax
    collection_method: Literal["charge_automatically", "send_invoice"]
    """
    Either `charge_automatically`, or `send_invoice`. When charging automatically, XPay will attempt to pay invoices at the end of the subscription cycle or on finalization using the default payment method attached to the subscription or customer. When sending an invoice, XPay will email your customer an invoice with payment instructions and mark the subscription as `active`. Defaults to `charge_automatically`.
    """
    computed: Computed
    created: int
    """
    ...
    """
    Details of the quote that was cloned. See the [cloning documentation](https://xpay.com/docs/quotes/clone) for more details.
    """
    header: Optional[str]
    """
    A header that will be displayed on the quote PDF.
    ...
    number: Optional[str]
    """
    A unique number that identifies this particular quote. This number is assigned once the quote is [finalized](https://xpay.com/docs/quotes/overview#finalize).
    """
    ...
    def create(
        ...
        **params: Unpack["Quote.CreateParams"]
        ...
        """
        A quote models prices and services for a customer. Default options for header, description, footer, and expires_at can be set in the dashboard via the [quote template](https://dashboard.xpay.com/settings/billing/quote).
        """
        return cast(
            "Quote",
            cls._static_request(
    ...
    def _cls_list_computed_upfront_line_items(
        ...
        **params: Unpack["Quote.ListComputedUpfrontLineItemsParams"]
        ...
        """
        When retrieving a quote, there is an includable [computed.upfront.line_items](https://xpay.com/docs/api/quotes/object#quote_object-computed-upfront-line_items) property containing the first handful of those items. There is also a URL where you can retrieve the full (paginated) list of upfront line items.
        """
        return cast(
            ListObject["LineItem"],
            cls._static_request(
    ...
    def _cls_pdf(
        ...
        **params
        ...
        requestor = api_requestor.APIRequestor(
            api_key,
            api_base=xpay.upload_api_base,
            api_version=xpay_version,
            account=xpay_account,
        )
    ...
    def pdf(  # type: ignore
        ...
        **params
        ...
        version = api_version or xpay_version
        requestor = api_requestor.APIRequestor(
            api_key,
            api_base=xpay.upload_api_base,
            api_version=version,
