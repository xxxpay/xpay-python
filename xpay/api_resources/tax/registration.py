...
class Registration(
    ...
    """
    A Tax `Registration` lets us know that your business is registered to collect tax on payments within a region, enabling you to [automatically collect tax](https://xpay.com/docs/tax).

    XPay doesn't register on your behalf with the relevant authorities when you create a Tax `Registration` object. For more information on how to register to collect tax, see [our guide](https://xpay.com/docs/tax/registering).

    Related guide: [Using the Registrations API](https://xpay.com/docs/tax/registrations-api)
    """

    OBJECT_NAME: ClassVar[Literal["tax.registration"]] = "tax.registration"

    class CountryOptions(XPayObject):
        class Ae(XPayObject):
        ...
        class Ca(XPayObject):
            class ProvinceStandard(XPayObject):
                province: str
                """
        ...
        class Us(XPayObject):
            class LocalAmusementTax(XPayObject):
                jurisdiction: str
                """
                A [FIPS code](https://www.census.gov/library/reference/code-lists/ansi.html) representing the local jurisdiction.
                """

            class LocalLeaseTax(XPayObject):
                jurisdiction: str
                """
                A [FIPS code](https://www.census.gov/library/reference/code-lists/ansi.html) representing the local jurisdiction.
                """
