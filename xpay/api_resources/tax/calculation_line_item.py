...
class CalculationLineItem(XPayObject):
    ...
    """
    The ID of an existing [Product](https://xpay.com/docs/api/products/object).
    """
    quantity: int
    """
    ...
    tax_code: str
    """
    The [tax code](https://xpay.com/docs/tax/tax-categories) ID used for this resource.
    """
