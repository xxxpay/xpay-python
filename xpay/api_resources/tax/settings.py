...
class Settings(
    ...
    """
    You can use Tax `Settings` to manage configurations used by XPay Tax calculations.

    Related guide: [Using the Settings API](https://xpay.com/docs/tax/settings-api)
    """

    OBJECT_NAME: ClassVar[Literal["tax.settings"]] = "tax.settings"

    class Defaults(XPayObject):
        tax_behavior: Optional[
            Literal["exclusive", "inclusive", "inferred_by_currency"]
        ]
        """
        Default [tax behavior](https://xpay.com/docs/tax/products-prices-tax-categories-tax-behavior#tax-behavior) used to specify whether the price is considered inclusive of taxes or exclusive of taxes. If the item's price has a tax behavior set, it will take precedence over the default tax behavior.
        """
        tax_code: Optional[str]
        """
        Default [tax code](https://xpay.com/docs/tax/tax-categories) used to classify your products and prices.
        """

    class HeadOffice(XPayObject):
    ...
    if TYPE_CHECKING:
        ...
        class ModifyParams(RequestOptions):
            ...
            """
            Default configuration to be used on XPay Tax calculations.
            """
        ...
        class ModifyParamsDefaults(TypedDict):
            ...
            """
            Specifies the default [tax behavior](https://xpay.com/docs/tax/products-prices-tax-categories-tax-behavior#tax-behavior) to be used when the item's price has unspecified tax behavior. One of inclusive, exclusive, or inferred_by_currency. Once specified, it cannot be changed back to null.
            """
