...
if TYPE_CHECKING:
    from xpay.api_resources.tax.calculation_line_item import (
        CalculationLineItem,
    )
...
class Calculation(CreateableAPIResource["Calculation"]):
    ...
    Related guide: [Calculate tax in your custom payment flow](https://xpay.com/docs/tax/custom)
    """
    ...
    class ShippingCost(XPayObject):
        class TaxBreakdown(XPayObject):
            class Jurisdiction(XPayObject):
                country: str
                """
                Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
                """
            ...
            class TaxRateDetails(XPayObject):
                display_name: str
                """
        ...
        """
        The ID of an existing [ShippingRate](https://xpay.com/docs/api/shipping_rates/object).
        """
        ...
        tax_code: str
        """
        The [tax code](https://xpay.com/docs/tax/tax-categories) ID used for shipping.
        """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParamsShippingCost(TypedDict):
            ...
            """
            If provided, the [shipping rate](https://xpay.com/docs/api/shipping_rates/object)'s `amount`, `tax_code` and `tax_behavior` are used. If you provide a shipping rate, then you cannot pass the `amount`, `tax_code`, or `tax_behavior` parameters.
            """
            ...
            """
            The [tax code](https://xpay.com/docs/tax/tax-categories) used to calculate tax on shipping. If not provided, the default shipping tax code from your [Tax Settings](https://xpay.com/settings/tax) is used.
            """
        ...
        class CreateParamsLineItem(TypedDict):
            ...
            """
            A custom identifier for this line item, which must be unique across the line items in the calculation. The reference helps identify each line item in exported [tax reports](https://xpay.com/docs/tax/reports).
            """
            tax_behavior: NotRequired["Literal['exclusive', 'inclusive']"]
            """
            ...
            tax_code: NotRequired["str"]
            """
            A [tax code](https://xpay.com/docs/tax/tax-categories) ID to use for this line item. If not provided, we will use the tax code from the provided `product` param. If neither `tax_code` nor `product` is provided, we will use the default tax code from your Tax Settings.
            """

        class CreateParamsCustomerDetails(TypedDict):
            address: NotRequired[
                "Calculation.CreateParamsCustomerDetailsAddress"
            ]
            """
            The customer's postal address (for example, home or business location).
            """
    ...
    """
    The ID of an existing [Customer](https://xpay.com/docs/api/customers/object) used for the resource.
    """
