...
if TYPE_CHECKING:
    from xpay.api_resources.tax.transaction_line_item import (
        TransactionLineItem,
    )
...
class Transaction(APIResource["Transaction"]):
    ...
    Related guide: [Calculate tax in your custom payment flow](https://xpay.com/docs/tax/custom#tax-transaction)
    """
    ...
    if TYPE_CHECKING:
        ...
        class CreateReversalParams(RequestOptions):
            ...
            reference: str
            """
            A custom identifier for this reversal, such as `myOrder_123-refund_1`, which must be unique across all transactions. The reference helps identify this reversal transaction in exported [tax reports](https://xpay.com/docs/tax/reports).
            """
        ...
        class CreateReversalParamsLineItem(TypedDict):
            ...
            """
            The quantity reversed. Appears in [tax exports](https://xpay.com/docs/tax/reports), but does not affect the amount of tax reversed.
            """
            reference: str
            """
