...
class ScheduledQueryRun(ListableAPIResource["ScheduledQueryRun"]):
    """
    If you have [scheduled a Sigma query](https://xpay.com/docs/sigma/scheduled-queries), you'll
    ...
    data_load_time: int
    """
    When the query was run, Sigma contained a snapshot of your XPay data at this time.
    """
