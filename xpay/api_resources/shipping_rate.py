...
if TYPE_CHECKING:
    from xpay.api_resources.tax_code import TaxCode
...
class ShippingRate(
    ...
    applied to a purchase. For more information, see [Charge for shipping](https://xpay.com/docs/payments/during-payment/charge-shipping).
    """

    OBJECT_NAME: ClassVar[Literal["shipping_rate"]] = "shipping_rate"

    class DeliveryEstimate(XPayObject):
        class Maximum(XPayObject):
