...
if TYPE_CHECKING:
    ...
    from xpay.api_resources.application import Application
    from xpay.api_resources.bank_account import BankAccount
    from xpay.api_resources.card import Card as CardResource
    from xpay.api_resources.charge import Charge
    from xpay.api_resources.customer import Customer
    from xpay.api_resources.invoice import Invoice
    from xpay.api_resources.payment_method import PaymentMethod
    from xpay.api_resources.review import Review
...
class PaymentIntent(
    ...
    [multiple statuses](https://xpay.com/docs/payments/intents#intent-statuses)
    throughout its lifetime as it interfaces with XPay.js to perform
    authentication flows and ultimately creates at most one successful charge.

    Related guide: [Payment Intents API](https://xpay.com/docs/payments/payment-intents)
    """

    OBJECT_NAME: ClassVar[Literal["payment_intent"]] = "payment_intent"

    class AmountDetails(XPayObject):
        class Tip(XPayObject):
            amount: Optional[int]
            """
    ...
    class AutomaticPaymentMethods(XPayObject):
        allow_redirects: Optional[Literal["always", "never"]]
        """
        Controls whether this PaymentIntent will accept redirect-based payment methods.

        Redirect-based payment methods may require your customer to be redirected to a payment method's app or site for authentication or additional steps. To [confirm](https://xpay.com/docs/api/payment_intents/confirm) this PaymentIntent, you may be required to provide a `return_url` to redirect customers back to your site after they authenticate or complete the payment.
        """
        enabled: bool
        """
    ...
    class LastPaymentError(XPayObject):
        charge: Optional[str]
        """
        ...
        """
        For some errors that could be handled programmatically, a short string indicating the [error code](https://xpay.com/docs/error-codes) reported.
        """
        decline_code: Optional[str]
        """
        For card errors resulting from a card issuer decline, a short string indicating the [card issuer's reason for the decline](https://xpay.com/docs/declines#issuer-declines) if they provide one.
        """
        doc_url: Optional[str]
        """
        A URL to more information about the [error code](https://xpay.com/docs/error-codes) reported.
        """
        ...
        You can use them with [PaymentIntents](https://xpay.com/docs/payments/payment-intents) to collect payments or save them to
        Customer objects to store instrument details for future payments.

        Related guides: [Payment Methods](https://xpay.com/docs/payments/payment-methods) and [More Payment Scenarios](https://xpay.com/docs/payments/more-payment-scenarios).
        """
        ...
        Later, you can use [PaymentIntents](https://xpay.com/docs/api#payment_intents) to drive the payment flow.

        Create a SetupIntent when you're ready to collect your customer's payment credentials.
        Don't maintain long-lived, unconfirmed SetupIntents because they might not be valid.
        The SetupIntent transitions through multiple [statuses](https://xpay.com/docs/payments/intents#intent-statuses) as it guides
        you through the setup process.

        Successful SetupIntents result in payment credentials that are optimized for future payments.
        For example, cardholders in [certain regions](https://xpay.com/guides/strong-customer-authentication) might need to be run through
        [Strong Customer Authentication](https://xpay.com/docs/strong-customer-authentication) during payment method collection
        to streamline later [off-session payments](https://xpay.com/docs/payments/setup-intents).
        If you use the SetupIntent with a [Customer](https://xpay.com/docs/api#setup_intent_object-customer),
        it automatically attaches the resulting payment method to that Customer after successful setup.
        We recommend using SetupIntents or [setup_future_usage](https://xpay.com/docs/api#payment_intent_object-setup_future_usage) on
        PaymentIntents to save payment methods to prevent saving invalid or unoptimized payment methods.

        By using SetupIntents, you can reduce friction for your customers, even as regulations change over time.

        Related guide: [Setup Intents API](https://xpay.com/docs/payments/setup-intents)
        """
        source: Optional[
    ...
    class NextAction(XPayObject):
        class AlipayHandleRedirect(XPayObject):
        ...
        class BoletoDisplayDetails(XPayObject):
        ...
        class CardAwaitNotification(XPayObject):
        ...
        class CashappHandleRedirectOrDisplayQrCode(XPayObject):
            class QrCode(XPayObject):
                expires_at: int
                """
        ...
        class DisplayBankTransferInstructions(XPayObject):
        ...
        class KonbiniDisplayDetails(XPayObject):
            class Stores(XPayObject):
                class Familymart(XPayObject):
        ...
        class OxxoDisplayDetails(XPayObject):
        ...
        class PaynowDisplayQrCode(XPayObject):
            data: str
            """
        ...
        class PixDisplayQrCode(XPayObject):
            data: Optional[str]
            """
            The raw data string used to generate QR code, it should be used together with QR code library.
            """
        ...
        class PromptpayDisplayQrCode(XPayObject):
            data: str
            """
            The raw data string used to generate QR code, it should be used together with QR code library.
            """
        ...
        class RedirectToUrl(XPayObject):
            return_url: Optional[str]
            """
            If the customer does not exit their browser while authenticating, they will be redirected to this specified URL after completion.
            """
        ...
        class VerifyWithMicrodeposits(XPayObject):
            arrival_date: int
            """
        ...
        class WechatPayDisplayQrCode(XPayObject):
            data: str
            """
        ...
        class WechatPayRedirectToAndroidApp(XPayObject):
            app_id: str
            """
        ...
        class WechatPayRedirectToIosApp(XPayObject):
            native_url: str
            """
        ...
        type: str
        """
        Type of the next action to perform, one of `redirect_to_url`, `use_xpay_sdk`, `alipay_handle_redirect`, `oxxo_display_details`, or `verify_with_microdeposits`.
        """
        use_xpay_sdk: Optional[Dict[str, Any]]
        """
        When confirming a PaymentIntent with XPay.js, XPay.js depends on the contents of this dictionary to invoke authentication flows. The shape of the contents is subject to change and is only intended to be used by XPay.js.
        """
    ...
    class PaymentMethodConfigurationDetails(XPayObject):
        id: str
        """
    ...
    class PaymentMethodOptions(XPayObject):
        class AcssDebit(XPayObject):
            class MandateOptions(XPayObject):
            ...
            Providing this parameter will [attach the payment method](https://xpay.com/docs/payments/save-during-payment) to the PaymentIntent's Customer, if present, after the PaymentIntent is confirmed and any required actions from the user are complete. If no Customer was provided, the payment method can still be [attached](https://xpay.com/docs/api/payment_methods/attach) to a Customer after the transaction completes.

            When processing card payments, XPay also uses `setup_future_usage` to dynamically optimize your payment flow and comply with regional legislation and network rules, such as [SCA](https://xpay.com/docs/strong-customer-authentication).
            """
        ...
        class AfterpayClearpay(XPayObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class Blik(XPayObject):
            pass

        class Boleto(XPayObject):
        ...
        class Card(XPayObject):
            class Installments(XPayObject):
                class AvailablePlan(XPayObject):
                    count: Optional[int]
                    """
            ...
            For more information, see the [installments integration guide](https://xpay.com/docs/payments/installments).
            """
            mandate_options: Optional[MandateOptions]
            """
            ...
            """
            Request ability to [capture beyond the standard authorization validity window](https://xpay.com/docs/payments/extended-authorization) for this PaymentIntent.
            """
            request_incremental_authorization: Optional[
                Literal["if_available", "never"]
            ]
            """
            Request ability to [increment](https://xpay.com/docs/payments/incremental-authorization) for this PaymentIntent.
            """
            request_multicapture: Optional[Literal["if_available", "never"]]
            """
            Request ability to make [multiple captures](https://xpay.com/docs/payments/multicapture) for this PaymentIntent.
            """
            request_overcapture: Optional[Literal["if_available", "never"]]
            """
            Request ability to [overcapture](https://xpay.com/docs/payments/overcapture) for this PaymentIntent.
            """
            request_three_d_secure: Optional[
                Literal["any", "automatic", "challenge_only"]
            ]
            """
            We strongly recommend that you rely on our SCA Engine to automatically prompt your customers for authentication based on risk level and [other requirements](https://xpay.com/docs/strong-customer-authentication). However, if you wish to request 3D Secure based on logic from your own fraud engine, provide this option. Permitted values include: `automatic` or `any`. If not provided, defaults to `automatic`. Read our guide on [manually requesting 3D Secure](https://xpay.com/docs/payments/3d-secure#manual-three-ds) for more information on how this configuration interacts with Radar and our SCA Engine.
            """
            setup_future_usage: Optional[
                Literal["none", "off_session", "on_session"]
            ]
        ...
        class CardPresent(XPayObject):
            request_extended_authorization: Optional[bool]
            """
            Request ability to capture this payment beyond the standard [authorization validity window](https://xpay.com/docs/terminal/features/extended-authorizations#authorization-validity)
            """
            request_incremental_authorization_support: Optional[bool]
            """
            Request ability to [increment](https://xpay.com/docs/terminal/features/incremental-authorizations) this PaymentIntent if the combination of MCC and card brand is eligible. Check [incremental_authorization_supported](https://xpay.com/docs/api/charges/object#charge_object-payment_method_details-card_present-incremental_authorization_supported) in the [Confirm](https://xpay.com/docs/api/payment_intents/confirm) response to verify support.
            """

        class Cashapp(XPayObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class CustomerBalance(XPayObject):
            class BankTransfer(XPayObject):
                class EuBankTransfer(XPayObject):
        ...
        class InteracPresent(XPayObject):
            pass

        class Klarna(XPayObject):
            capture_method: Optional[Literal["manual"]]
            """
            Controls when the funds will be captured from the customer's account.
            """
        ...
        class RevolutPay(XPayObject):
            pass

        class SepaDebit(XPayObject):
            class MandateOptions(XPayObject):
                pass
        ...
        class UsBankAccount(XPayObject):
            class FinancialConnections(XPayObject):
    ...
    class Processing(XPayObject):
        class Card(XPayObject):
            class CustomerNotification(XPayObject):
    ...
    class Shipping(XPayObject):
        class Address(XPayObject):
            city: Optional[str]
            """
    ...
    class TransferData(XPayObject):
        amount: Optional[int]
        """
        Amount intended to be collected by this PaymentIntent. A positive integer representing how much to charge in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal) (e.g., 100 cents to charge $1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is $0.50 US or [equivalent in charge currency](https://xpay.com/docs/currencies#minimum-and-maximum-charge-amounts). The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of $999,999.99).
        """
    ...
    if TYPE_CHECKING:
        ...
        class ApplyCustomerBalanceParams(RequestOptions):
            ...
            A positive integer representing how much to charge in the [smallest currency unit](https://xpay.com/docs/currencies#zero-decimal) (for example, 100 cents to charge 1 USD or 100 to charge 100 JPY, a zero-decimal currency).
        ...
        class CancelParams(RequestOptions):
            cancellation_reason: NotRequired[
                "Literal['abandoned', 'duplicate', 'fraudulent', 'requested_by_customer']"
            ]
            """
        ...
        class CaptureParams(RequestOptions):
            ...
            """
            The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's XPay account. The amount of the application fee collected will be capped at the total payment amount. For more information, see the PaymentIntents [use case for connected accounts](https://xpay.com/docs/payments/connected-accounts).
            """
            expand: NotRequired["List[str]"]
            """
            Specifies which fields in the response should be expanded.
            ...
            """
            Defaults to `true`. When capturing a PaymentIntent, setting `final_capture` to `false` notifies XPay to not release the remaining uncaptured funds to make sure that they're captured in future requests. You can only use this setting when [multicapture](https://xpay.com/docs/payments/multicapture) is available for PaymentIntents.
            """
            ...
            transfer_data: NotRequired[
                "PaymentIntent.CaptureParamsTransferData"
            ]
            """
            The parameters that you can use to automatically create a transfer after the payment
            is captured. Learn more about the [use case for connected accounts](https://xpay.com/docs/payments/connected-accounts).
            """
        ...
        class ConfirmParams(RequestOptions):
            ...
            """
            Set to `true` to fail the payment attempt if the PaymentIntent transitions into `requires_action`. This parameter is intended for simpler integrations that do not handle customer actions, like [saving cards without authentication](https://xpay.com/docs/payments/save-card-without-authentication).
            """
            expand: NotRequired["List[str]"]
            """
            Specifies which fields in the response should be expanded.
            ...
            """
            Set to `true` to indicate that the customer isn't in your checkout flow during this payment attempt and can't authenticate. Use this parameter in scenarios where you collect card details and [charge them later](https://xpay.com/docs/payments/cards/charging-saved-cards).
            """
            payment_method: NotRequired["str"]
            """
            ID of the payment method (a PaymentMethod, Card, or [compatible Source](https://xpay.com/docs/payments/payment-methods/transitioning#compatibility) object) to attach to this PaymentIntent.
            """
            ...
            in the [payment_method](https://xpay.com/docs/api/payment_intents/object#payment_intent_object-payment_method)
            ...
            radar_options: NotRequired[
                "PaymentIntent.ConfirmParamsRadarOptions"
            ]
            """
            Options to configure Radar. Learn more about [Radar Sessions](https://xpay.com/docs/radar/radar-session).
            """
            receipt_email: NotRequired["Literal['']|str"]
            """
            Email address that the receipt for the resulting payment will be sent to. If `receipt_email` is specified for a payment in live mode, a receipt will be sent regardless of your [email settings](https://dashboard.xpay.com/account/emails).
            """
            ...
            """
            use_xpay_sdk: NotRequired["bool"]
            """
            Set to `true` when confirming server-side and using XPay.js, iOS, or Android client-side SDKs to handle the next actions.
            """
        ...
        class ConfirmParamsRadarOptions(TypedDict):
            ...
            """
            A [Radar Session](https://xpay.com/docs/radar/radar-session) is a snapshot of the browser metadata and device details that help Radar make more accurate predictions on your payments.
            """
        ...
        class ConfirmParamsPaymentMethodOptionsPaypal(TypedDict):
            ...
            """
            [Preferred locale](https://xpay.com/docs/payments/paypal/supported-locales) of the PayPal checkout page that the customer is redirected to.
            """
        ...
        class ConfirmParamsPaymentMethodData(TypedDict):
            ...
            """
            blik: NotRequired[
                "PaymentIntent.ConfirmParamsPaymentMethodDataBlik"
            ]
            """
            ...
            """
            ideal: NotRequired[
                "PaymentIntent.ConfirmParamsPaymentMethodDataIdeal"
            ]
            """
            ...
            """
            link: NotRequired[
                "PaymentIntent.ConfirmParamsPaymentMethodDataLink"
            ]
            """
            ...
            """
            oxxo: NotRequired[
                "PaymentIntent.ConfirmParamsPaymentMethodDataOxxo"
            ]
            """
            ...
            """
            Options to configure Radar. See [Radar Session](https://xpay.com/docs/radar/radar-session) for more information.
            """
            revolut_pay: NotRequired[
        ...
        class CreateParams(RequestOptions):
            ...
            """
            Set to `true` to attempt to [confirm this PaymentIntent](https://xpay.com/docs/api/payment_intents/confirm) this PaymentIntent immediately. This parameter defaults to `false`. When creating and confirming a PaymentIntent at the same time, you can also provide the parameters available in the [Confirm API](https://xpay.com/docs/api/payment_intents/confirm).
            """
            ...
            If present in combination with [setup_future_usage](https://xpay.com/docs/api#payment_intent_object-setup_future_usage), this PaymentIntent's payment method will be attached to the Customer after the PaymentIntent has been confirmed and any required actions from the user are complete.
            """
            description: NotRequired["str"]
            """
            ...
            error_on_requires_action: NotRequired["bool"]
            """
            Set to `true` to fail the payment attempt if the PaymentIntent transitions into `requires_action`. Use this parameter for simpler integrations that don't handle customer actions, such as [saving cards without authentication](https://xpay.com/docs/payments/save-card-without-authentication). This parameter can only be used with [`confirm=true`](https://xpay.com/docs/api/payment_intents/create#create_payment_intent-confirm).
            """
            expand: NotRequired["List[str]"]
            """
            Specifies which fields in the response should be expanded.
            ...
            mandate: NotRequired["str"]
            """
            ID of the mandate that's used for this payment. This parameter can only be used with [`confirm=true`](https://xpay.com/docs/api/payment_intents/create#create_payment_intent-confirm).
            """
            mandate_data: NotRequired[
                "Literal['']|PaymentIntent.CreateParamsMandateData"
            ]
            """
            This hash contains details about the Mandate to create. This parameter can only be used with [`confirm=true`](https://xpay.com/docs/api/payment_intents/create#create_payment_intent-confirm).
            """
            metadata: NotRequired["Dict[str, str]"]
            """
            Set of [key-value pairs](https://xpay.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
            ...
            off_session: NotRequired["bool|Literal['one_off', 'recurring']"]
            """
            Set to `true` to indicate that the customer isn't in your checkout flow during this payment attempt and can't authenticate. Use this parameter in scenarios where you collect card details and [charge them later](https://xpay.com/docs/payments/cards/charging-saved-cards). This parameter can only be used with [`confirm=true`](https://xpay.com/docs/api/payment_intents/create#create_payment_intent-confirm).
            """
            on_behalf_of: NotRequired["str"]
            """
            The XPay account ID that these funds are intended for. Learn more about the [use case for connected accounts](https://xpay.com/docs/payments/connected-accounts).
            """
            payment_method: NotRequired["str"]
            """
            ID of the payment method (a PaymentMethod, Card, or [compatible Source](https://xpay.com/docs/payments/payment-methods#compatibility) object) to attach to this PaymentIntent.
            ...
            """
            The list of payment method types (for example, a card) that this PaymentIntent can use. If you don't provide this, it defaults to ["card"]. Use `automatic_payment_methods` to manage payment methods from the [XPay Dashboard](https://dashboard.xpay.com/settings/payment_methods).
            """
            radar_options: NotRequired[
                "PaymentIntent.CreateParamsRadarOptions"
            ]
            """
            Options to configure Radar. Learn more about [Radar Sessions](https://xpay.com/docs/radar/radar-session).
            """
            ...
            """
            Email address to send the receipt to. If you specify `receipt_email` for a payment in live mode, you send a receipt regardless of your [email settings](https://dashboard.xpay.com/account/emails).
            """
            return_url: NotRequired["str"]
            """
            The URL to redirect your customer back to after they authenticate or cancel their payment on the payment method's app or site. If you'd prefer to redirect to a mobile application, you can alternatively supply an application URI scheme. This parameter can only be used with [`confirm=true`](https://xpay.com/docs/api/payment_intents/create#create_payment_intent-confirm).
            """
            setup_future_usage: NotRequired[
            ...
            """
            transfer_data: NotRequired[
                "PaymentIntent.CreateParamsTransferData"
            ]
            """
            The parameters that you can use to automatically create a Transfer.
            Learn more about the [use case for connected accounts](https://xpay.com/docs/payments/connected-accounts).
            """
            transfer_group: NotRequired["str"]
            """
            A string that identifies the resulting payment as part of a group. Learn more about the [use case for connected accounts](https://xpay.com/docs/connect/separate-charges-and-transfers).
            """
            use_xpay_sdk: NotRequired["bool"]
            """
            Set to `true` when confirming server-side and using XPay.js, iOS, or Android client-side SDKs to handle the next actions.
        ...
        class CreateParamsTransferData(TypedDict):
            ...
            [application_fee_amount](https://xpay.com/docs/api/payment_intents/create#create_payment_intent-application_fee_amount)
        ...
        class CreateParamsPaymentMethodData(TypedDict):
            ...
            """
            ideal: NotRequired[
                "PaymentIntent.CreateParamsPaymentMethodDataIdeal"
            ]
            """
            If this is an `ideal` PaymentMethod, this hash contains details about the iDEAL payment method.
            """
            ...
            """
            link: NotRequired[
                "PaymentIntent.CreateParamsPaymentMethodDataLink"
            ]
            """
            If this is an `Link` PaymentMethod, this hash contains details about the Link payment method.
            """
            ...
            """
            oxxo: NotRequired[
                "PaymentIntent.CreateParamsPaymentMethodDataOxxo"
            ]
            """
            If this is an `oxxo` PaymentMethod, this hash contains details about the OXXO payment method.
            """
        ...
        class ModifyParams(RequestOptions):
            ...
            payment_method_types: NotRequired["List[str]"]
            """
            The list of payment method types (for example, card) that this PaymentIntent can use. Use `automatic_payment_methods` to manage payment methods from the [XPay Dashboard](https://dashboard.xpay.com/settings/payment_methods).
            """
            receipt_email: NotRequired["Literal['']|str"]
            """
            Email address that the receipt for the resulting payment will be sent to. If `receipt_email` is specified for a payment in live mode, a receipt will be sent regardless of your [email settings](https://dashboard.xpay.com/account/emails).
            ...
            """
            shipping: NotRequired[
                "Literal['']|PaymentIntent.ModifyParamsShipping"
            ]
            """
            Shipping information for this PaymentIntent.
            """
            ...
            """
            transfer_data: NotRequired[
                "PaymentIntent.ModifyParamsTransferData"
            ]
            """
            Use this parameter to automatically create a Transfer when the payment succeeds. Learn more about the [use case for connected accounts](https://xpay.com/docs/payments/connected-accounts).
            """
            transfer_group: NotRequired["str"]
            """
            A string that identifies the resulting payment as part of a group. You can only provide `transfer_group` if it hasn't been set. Learn more about the [use case for connected accounts](https://xpay.com/docs/payments/connected-accounts).
            """
        ...
        class ModifyParamsPaymentMethodData(TypedDict):
            ...
            """
            blik: NotRequired[
                "PaymentIntent.ModifyParamsPaymentMethodDataBlik"
            ]
            """
            If this is a `blik` PaymentMethod, this hash contains details about the BLIK payment method.
            """
            ...
            """
            ideal: NotRequired[
                "PaymentIntent.ModifyParamsPaymentMethodDataIdeal"
            ]
            """
            If this is an `ideal` PaymentMethod, this hash contains details about the iDEAL payment method.
            """
            ...
            """
            link: NotRequired[
                "PaymentIntent.ModifyParamsPaymentMethodDataLink"
            ]
            """
            If this is an `Link` PaymentMethod, this hash contains details about the Link payment method.
            """
            ...
            """
            oxxo: NotRequired[
                "PaymentIntent.ModifyParamsPaymentMethodDataOxxo"
            ]
            """
            If this is an `oxxo` PaymentMethod, this hash contains details about the OXXO payment method.
            """
        ...
        class SearchParams(RequestOptions):
            ...
            query: str
            """
            The search query string. See [search query language](https://xpay.com/docs/search#search-query-language) and the list of supported [query fields for payment intents](https://xpay.com/docs/search#query-fields-for-payment-intents).
            """
    ...
    """
    Settings to configure compatible payment methods from the [XPay Dashboard](https://dashboard.xpay.com/settings/payment_methods)
    """
    ...
    """
    Reason for cancellation of this PaymentIntent, either user-provided (`duplicate`, `fraudulent`, `requested_by_customer`, or `abandoned`) or generated by XPay internally (`failed_invoice`, `void_invoice`, or `automatic`).
    """
    ...
    Refer to our docs to [accept a payment](https://xpay.com/docs/payments/accept-a-payment?ui=elements) and learn about how `client_secret` should be handled.
    """
    ...
    """
    Set of [key-value pairs](https://xpay.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Learn more about [storing information in metadata](https://xpay.com/docs/payments/payment-intents/creating-payment-intents#storing-information-in-metadata).
    """
    ...
    """
    The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents [use case for connected accounts](https://xpay.com/docs/payments/connected-accounts) for details.
    """
    ...
    """
    Status of this PaymentIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `requires_capture`, `canceled`, or `succeeded`. Read more about each PaymentIntent [status](https://xpay.com/docs/payments/intents#intent-statuses).
    """
    transfer_data: Optional[TransferData]
    """
    The data that automatically creates a Transfer after the payment finalizes. Learn more about the [use case for connected accounts](https://xpay.com/docs/payments/connected-accounts).
    """
    ...
    def _cls_cancel(
        ...
        **params: Unpack["PaymentIntent.CancelParams"]
        ...
        """
        You can cancel a PaymentIntent object when it's in one of these statuses: requires_payment_method, requires_capture, requires_confirmation, requires_action or, [in rare cases](https://xpay.com/docs/payments/intents), processing.

        After it's canceled, no additional charges are made by the PaymentIntent and any operations on the PaymentIntent fail with an error. For PaymentIntents with a status of requires_capture, the remaining amount_capturable is automatically refunded.

        You can't cancel the PaymentIntent for a Checkout Session. [Expire the Checkout Session](https://xpay.com/docs/api/checkout/sessions/expire) instead.
        """
        return cast(
            "PaymentIntent",
            cls._static_request(
    ...
    def _cls_capture(
        ...
        **params: Unpack["PaymentIntent.CaptureParams"]
        ...
        Learn more about [separate authorization and capture](https://xpay.com/docs/payments/capture-later).
        """
        return cast(
            "PaymentIntent",
            cls._static_request(
    ...
    def _cls_confirm(
        ...
        **params: Unpack["PaymentIntent.ConfirmParams"]
        ...
        using our [client SDKs](https://xpay.com/docs/xpay-js/reference#xpay-handle-card-payment)
        and the PaymentIntent's [client_secret](https://xpay.com/docs/api#payment_intent_object-client_secret).
        ...
        attempt. Read the [expanded documentation](https://xpay.com/docs/payments/payment-intents/web-manual)
    ...
    def create(
        ...
        **params: Unpack["PaymentIntent.CreateParams"]
        ...
        After the PaymentIntent is created, attach a payment method and [confirm](https://xpay.com/docs/api/payment_intents/confirm)
        to continue the payment. Learn more about <a href="/docs/payments/payment-intents">the available payment flows
        with the Payment Intents API.

        When you use confirm=true during creation, it's equivalent to creating
        and confirming the PaymentIntent in the same call. You can use any parameters
        available in the [confirm API](https://xpay.com/docs/api/payment_intents/confirm) when you supply
        confirm=true.
        """
        return cast(
            "PaymentIntent",
    ...
    def _cls_increment_authorization(
        ...
        **params: Unpack["PaymentIntent.IncrementAuthorizationParams"]
        ...
        [PaymentIntent](https://xpay.com/docs/api/payment_intents/object). To be eligible, the
        PaymentIntent's status must be requires_capture and
        [incremental_authorization_supported](https://xpay.com/docs/api/charges/object#charge_object-payment_method_details-card_present-incremental_authorization_supported)
        must be true.
        ...
        [amount](https://xpay.com/docs/api/payment_intents/object#payment_intent_object-amount).
        If the incremental authorization fails, a
        [card_declined](https://xpay.com/docs/error-codes#card-declined) error returns, and no other
        ...
        Learn more about [incremental authorizations](https://xpay.com/docs/terminal/features/incremental-authorizations).
        """
        return cast(
            "PaymentIntent",
            cls._static_request(
    ...
    def modify(
        ...
        the [confirm API](https://xpay.com/docs/api/payment_intents/confirm) instead.
        """
    ...
    def retrieve(
        ...
        If you retrieve a PaymentIntent with a publishable key, it only returns a subset of properties. Refer to the [payment intent](https://xpay.com/docs/api#payment_intent_object) object reference for more details.
        """
    ...
    def search(
        ...
        """
        Search for PaymentIntents you've previously created using XPay's [Search Query Language](https://xpay.com/docs/search#search-query-language).
