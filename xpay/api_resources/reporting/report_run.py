...
class ReportRun(
    ...
    specific run parameters. Once the object is created, XPay begins processing the report.
    When the report has finished running, it will give you a reference to a file
    where you can retrieve your results. For an overview, see
    [API Access to Reports](https://xpay.com/docs/reporting/statements/api).

    Note that certain report types can only be run based on your live-mode data (not test-mode
    data), and will error when queried without a [live-mode API key](https://xpay.com/docs/keys#test-live-modes).
    """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            Parameters specifying how the report should be run. Different Report Types have different required and optional parameters, listed in the [API Access to Reports](https://xpay.com/docs/reporting/statements/api) documentation.
            """
            report_type: str
            """
            The ID of the [report type](https://xpay.com/docs/reporting/statements/api#report-types) to run, such as `"balance.summary.1"`.
            """
    ...
    report_type: str
    """
    The ID of the [report type](https://xpay.com/docs/reports/report-types) to run, such as `"balance.summary.1"`.
    """
    ...
    def create(
        ...
        **params: Unpack["ReportRun.CreateParams"]
        ...
        """
        Creates a new object and begin running the report. (Certain report types require a [live-mode API key](https://xpay.com/docs/keys#test-live-modes).)
        """
        return cast(
            "ReportRun",
            cls._static_request(
