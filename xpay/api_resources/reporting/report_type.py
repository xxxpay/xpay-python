...
class ReportType(ListableAPIResource["ReportType"]):
    ...
    [API Access to Reports documentation](https://xpay.com/docs/reporting/statements/api)
    ...
    id: str
    """
    The [ID of the Report Type](https://xpay.com/docs/reporting/statements/api#available-report-types), such as `balance.summary.1`.
    """
    livemode: bool
    """
    ...
    def retrieve(
        ...
        """
        Retrieves the details of a Report Type. (Certain report types require a [live-mode API key](https://xpay.com/docs/keys#test-live-modes).)
        """
