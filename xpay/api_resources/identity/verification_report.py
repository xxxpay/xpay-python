...
class VerificationReport(ListableAPIResource["VerificationReport"]):
    ...
    reference IDs which can be used to access collected images through the [FileUpload](https://xpay.com/docs/api/files)
    API. To configure and create VerificationReports, use the
    [VerificationSession](https://xpay.com/docs/api/identity/verification_sessions) API.

    Related guides: [Accessing verification results](https://xpay.com/docs/identity/verification-sessions#results).
    """
    ...
    class Document(XPayObject):
        ...
        class ExpirationDate(XPayObject):
            day: Optional[int]
            """
            Numerical day between 1 and 31.
            """
        ...
        """
        Array of [File](https://xpay.com/docs/api/files) ids containing images for this document.
        """
    ...
    class Selfie(XPayObject):
        ...
        """
        ID of the [File](https://xpay.com/docs/api/files) holding the image of the identity document used in this check.
        """
        error: Optional[Error]
        """
        Details on the verification error. Present when status is `unverified`.
        ...
        selfie: Optional[str]
        """
        ID of the [File](https://xpay.com/docs/api/files) holding the image of the selfie used in this check.
        """
        status: Literal["unverified", "verified"]
        """
