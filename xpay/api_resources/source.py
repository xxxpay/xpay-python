...
from xpay import error, util
from xpay.api_resources import Customer
...
if TYPE_CHECKING:
    from xpay.api_resources.source_transaction import SourceTransaction


class Source(CreateableAPIResource["Source"], UpdateableAPIResource["Source"]):
    """
    `Source` objects allow you to accept a variety of payment methods. They
    represent a customer's payment instrument, and can be used with the XPay API
    just like a `Card` object: once chargeable, they can be charged, or can be
    attached to customers.

    XPay doesn't recommend using the deprecated [Sources API](https://xpay.com/docs/api/sources).
    We recommend that you adopt the [PaymentMethods API](https://xpay.com/docs/api/payment_methods).
    This newer API provides access to our latest features and payment method types.

    Related guides: [Sources API](https://xpay.com/docs/sources) and [Sources & Customers](https://xpay.com/docs/sources/customers).
    """

    OBJECT_NAME: ClassVar[Literal["source"]] = "source"

    class AchCreditTransfer(XPayObject):
    ...
    class CodeVerification(XPayObject):
    ...
    class Owner(XPayObject):
        ...
        class VerifiedAddress(XPayObject):
            city: Optional[str]
            """
            City, district, suburb, town, or village.
            """
    ...
    class SepaCreditTransfer(XPayObject):
        bank_name: Optional[str]
        bic: Optional[str]
        iban: Optional[str]
        refund_account_holder_address_city: Optional[str]
    ...
    class SourceOrder(XPayObject):
        class Item(XPayObject):
            amount: Optional[int]
            """
    ...
    if TYPE_CHECKING:
        ...
        class CreateParams(RequestOptions):
            ...
            """
            Three-letter [ISO code for the currency](https://xpay.com/docs/currencies) associated with the source. This is the currency for which the source will be chargeable once ready.
            """
            ...
            """
            The `type` of the source to create. Required unless `customer` and `original_source` are specified (see the [Cloning card Sources](https://xpay.com/docs/sources/connect#cloning-card-sources) guide)
            """
        ...
        class CreateParamsReceiver(TypedDict):
            ...
            """
            The method XPay should use to request information needed to process a refund or mispayment. Either `email` (an email is sent directly to the customer) or `manual` (a `source.refund_attributes_required` event is sent to your webhooks endpoint). Refer to each payment method's documentation to learn which refund attributes may be required.
            """
        ...
        class CreateParamsMandate(TypedDict):
            ...
            """
            The parameters required to notify XPay of a mandate acceptance or refusal by the customer.
            """
            ...
            notification_method: NotRequired[
                "Literal['deprecated_none', 'email', 'manual', 'none', 'xpay_email']"
            ]
            """
            The method XPay should use to notify the customer of upcoming debit instructions and/or mandate confirmation as required by the underlying debit network. Either `email` (an email is sent directly to the customer), `manual` (a `source.mandate_notification` event is sent to your webhooks endpoint and you should handle the notification) or `none` (the underlying debit network does not require any notification).
            """
    ...
    currency: Optional[str]
    """
    Three-letter [ISO code for the currency](https://xpay.com/docs/currencies) associated with the source. This is the currency for which the source will be chargeable once ready. Required for `single_use` sources.
    """
    customer: Optional[str]
    """
    ...
    def modify(
        ...
        This request accepts the metadata and owner as arguments. It is also possible to update type specific information for selected payment methods. Please refer to our [payment method guides](https://xpay.com/docs/sources) for more detail.
        """
    ...
    def retrieve(
        ...
        """
        Retrieves an existing source object. Supply the unique source ID from a source creation request and XPay will return the corresponding up-to-date source object information.
        """
