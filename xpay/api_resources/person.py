...
from xpay.api_resources.abstract import UpdateableAPIResource
from xpay.api_resources.account import Account as AccountResource
...
class Person(UpdateableAPIResource["Person"]):
    """
    This is an object representing a person associated with a XPay account.

    A platform cannot access a Standard or Express account's persons after the account starts onboarding, such as after generating an account link for the account.
    See the [Standard onboarding](https://xpay.com/docs/connect/standard-accounts) or [Express onboarding documentation](https://xpay.com/docs/connect/express-accounts) for information about platform prefilling and account onboarding steps.

    Related guide: [Handling identity verification with the API](https://xpay.com/docs/connect/handling-api-verification#person-information)
    """

    OBJECT_NAME: ClassVar[Literal["person"]] = "person"

    class AdditionalTosAcceptances(XPayObject):
        class Account(XPayObject):
            date: Optional[int]
            """
    ...
    class FutureRequirements(XPayObject):
        class Alternative(XPayObject):
    ...
    class RegisteredAddress(XPayObject):
        city: Optional[str]
        """
        City, district, suburb, town, or village.
        """
    ...
    class Verification(XPayObject):
        class AdditionalDocument(XPayObject):
    ...
    """
    Information about the [upcoming new requirements for this person](https://xpay.com/docs/connect/custom-accounts/future-requirements), including what information needs to be collected, and by when.
    """
    gender: Optional[str]
    """
    ...
    def modify(cls, sid, **params):
        raise NotImplementedError(
            ...
            "Use xpay.Account.modify_person('account_id', 'person_id', ...) "
            "(see https://xpay.com/docs/api/persons/update)."
        )
    ...
    def retrieve(cls, id, api_key=None, **params):
        raise NotImplementedError(
            ...
            "Use xpay.Account.retrieve_person('account_id', 'person_id') "
            "(see https://xpay.com/docs/api/persons/retrieve)."
        )
