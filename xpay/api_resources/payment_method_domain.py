...
class PaymentMethodDomain(
    ...
    """
    A payment method domain represents a web domain that you have registered with XPay.
    XPay Elements use registered payment method domains to control where certain payment methods are shown.

    Related guides: [Payment method domains](https://xpay.com/docs/payments/payment-methods/pmd-registration).
    """
