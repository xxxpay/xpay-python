...
class Review(ListableAPIResource["Review"]):
    ...
    Learn more about [Radar](https://xpay.com/radar) and reviewing payments
    [here](https://xpay.com/docs/radar/reviews).
    """

    OBJECT_NAME: ClassVar[Literal["review"]] = "review"

    class IpAddressLocation(XPayObject):
        city: Optional[str]
        """
