...
class CountrySpec(ListableAPIResource["CountrySpec"]):
    """
    XPay needs to collect certain pieces of information about each account
    created. These requirements can differ depending on the account's country. The
    Country Specs API makes these rules available to your integration.

    You can also view the information from this API call as [an online
    guide](https://xpay.com/docs/connect/required-verification-information).
    """

    OBJECT_NAME: ClassVar[Literal["country_spec"]] = "country_spec"

    class VerificationFields(XPayObject):
    ...
    """
    Payment methods available in the specified country. You may need to enable some payment methods (e.g., [ACH](https://xpay.com/docs/ach)) on your account before they appear in this list. The `xpay` payment method refers to [charging through your platform](https://xpay.com/docs/connect/destination-charges).
    """
